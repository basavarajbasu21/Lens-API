...
export declare function success<T extends void>(): Success<T, never>;
export declare function success<T>(value: T): Success<T, never>;
export declare const failure: <E extends IEquatableError<string, string>>(error: E) => Failure<never, E>;
/**
 * Returns `true` if the result is a success.
 */
export declare function assertSuccess<T>(result: Result<T, IEquatableError>): asserts result is Success<T, never>;
/**
 * Returns `true` if the result is a failure.
 */
export declare function assertFailure<T, E extends IEquatableError>(result: Result<T, E>): asserts result is Failure<never, E>;
