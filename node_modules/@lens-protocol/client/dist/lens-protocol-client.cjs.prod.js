...
var _templateObject$g, _templateObject2$g, _templateObject3$c, _templateObject4$b;
var AuthChallengeDocument = gql__default["default"](_templateObject$g || (_templateObject$g = _taggedTemplateLiteral(["\n  query AuthChallenge($address: EthereumAddress!) {\n    result: challenge(request: { address: $address }) {\n      text\n    }\n  }\n"])));
var AuthVerifyDocument = gql__default["default"](_templateObject2$g || (_templateObject2$g = _taggedTemplateLiteral(["\n  query AuthVerify($accessToken: Jwt!) {\n    result: verify(request: { accessToken: $accessToken })\n  }\n"])));
var AuthAuthenticateDocument = gql__default["default"](_templateObject3$c || (_templateObject3$c = _taggedTemplateLiteral(["\n  mutation AuthAuthenticate($address: EthereumAddress!, $signature: Signature!) {\n    result: authenticate(request: { address: $address, signature: $signature }) {\n      accessToken\n      refreshToken\n    }\n  }\n"])));
var AuthRefreshDocument = gql__default["default"](_templateObject4$b || (_templateObject4$b = _taggedTemplateLiteral(["\n  mutation AuthRefresh($refreshToken: Jwt!) {\n    result: refresh(request: { refreshToken: $refreshToken }) {\n      accessToken\n      refreshToken\n    }\n  }\n"])));
var defaultWrapper$f = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var AuthChallengeDocumentString = graphql.print(AuthChallengeDocument);
var AuthVerifyDocumentString = graphql.print(AuthVerifyDocument);
var AuthAuthenticateDocumentString = graphql.print(AuthAuthenticateDocument);
var AuthRefreshDocumentString = graphql.print(AuthRefreshDocument);
function getSdk$f(client) {
  var withWrapper = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultWrapper$f;
  return {
...
var TOKEN_EXP_THRESHOLD = sharedKernel.DateUtils.secondsToMs(30);
var CLOCK_SKEWED_THRESHOLD = sharedKernel.DateUtils.secondsToMs(10);
var Credentials = /*#__PURE__*/function () {
  ...
  _createClass(Credentials, [{
    ...
    value: function checkClock() {
      var decodedToken = jwtDecode__default["default"](this.refreshToken);
      sharedKernel.invariant(decodedToken.iat, 'Issued at date should be provided by JWT token');

      // check if local time is not too far off from server time
      if (Math.abs(sharedKernel.DateUtils.secondsToMs(decodedToken.iat) - Date.now()) > CLOCK_SKEWED_THRESHOLD) {
...
var CredentialsStorage = /*#__PURE__*/function () {
  function CredentialsStorage(storageProvider, namespace) {
    ...
    var authStorageSchema = new storage.BaseStorageSchema("lens.".concat(namespace, ".credentials"), AuthData);
...
var Authentication = /*#__PURE__*/function () {
  function Authentication(config) {
    ...
    this.storage = new CredentialsStorage(config.storage || new storage.InMemoryStorageProvider(), config.environment.name);
  }
  _createClass(Authentication, [{
    ...
    key: "verify",
    value: function () {
      var _verify = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(accessToken) {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              return _context4.abrupt("return", this.api.verify(accessToken));
            case 1:
            case "end":
              return _context4.stop();
          }
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 2:
              ...
              return _context5.abrupt("return", sharedKernel.failure(new NotAuthenticatedError()));
            case 5:
              if (!(!credentials.shouldRefresh() && credentials.accessToken)) {
                _context5.next = 7;
                break;
              }
              return _context5.abrupt("return", sharedKernel.success(credentials.accessToken));
            case 7:
              if (!credentials.canRefresh()) {
                _context5.next = 16;
                break;
            ...
            case 13:
              ...
              return _context5.abrupt("return", sharedKernel.failure(new CredentialsExpiredError()));
            case 15:
              return _context5.abrupt("return", sharedKernel.success(newCredentials.accessToken));
            case 16:
              return _context5.abrupt("return", sharedKernel.failure(new CredentialsExpiredError()));
            case 17:
            case "end":
    ...
    value: function () {
      var _getRequestHeader = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var credentials, newCredentials;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 2:
              ...
              return _context6.abrupt("return", sharedKernel.failure(new NotAuthenticatedError()));
            case 5:
              if (credentials.shouldRefresh()) {
                _context6.next = 7;
                break;
              }
              return _context6.abrupt("return", sharedKernel.success(this.buildHeader(credentials.accessToken)));
            case 7:
              if (!credentials.canRefresh()) {
                _context6.next = 14;
                break;
            ...
            case 10:
              ...
              return this.storage.set(newCredentials);
            case 13:
              return _context6.abrupt("return", sharedKernel.success(this.buildHeader(newCredentials.accessToken)));
            case 14:
              return _context6.abrupt("return", sharedKernel.failure(new CredentialsExpiredError()));
            case 15:
            case "end":
...
function buildMediaTransformsFromConfig() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", sharedKernel.failure(new NotAuthenticatedError()));
        case 2:
          _context.next = 4;
          return authentication.getRequestHeader();
        case 4:
          ...
          return _context.abrupt("return", sharedKernel.failure(headerResult.error));
        case 7:
          _context.next = 9;
          return handler(headerResult.value);
        case 9:
          result = _context.sent;
          return _context.abrupt("return", sharedKernel.success(result));
        case 11:
        case "end":
          return _context.stop();
      }
...
var _templateObject$f, _templateObject2$f, _templateObject3$b, _templateObject4$a, _templateObject5$9, _templateObject6$6, _templateObject7$6, _templateObject8$4, _templateObject9$4, _templateObject10$3, _templateObject11$3, _templateObject12$2, _templateObject13$2, _templateObject14$2, _templateObject15$2, _templateObject16$2, _templateObject17$2, _templateObject18$2, _templateObject19$2, _templateObject20$2, _templateObject21$2, _templateObject22$2, _templateObject23$2, _templateObject24$2, _templateObject25$2, _templateObject26$2, _templateObject27$2, _templateObject28$2, _templateObject29$2, _templateObject30$2, _templateObject31$1, _templateObject32$1, _templateObject33$1, _templateObject34$1, _templateObject35$1, _templateObject36$1, _templateObject37$1, _templateObject38$1, _templateObject39, _templateObject40;
var Eip712TypedDataDomainFragmentDoc = gql__default["default"](_templateObject$f || (_templateObject$f = _taggedTemplateLiteral(["\n  fragment EIP712TypedDataDomain on EIP712TypedDataDomain {\n    name\n    chainId\n    version\n    verifyingContract\n  }\n"])));
var Erc20FragmentDoc = gql__default["default"](_templateObject2$f || (_templateObject2$f = _taggedTemplateLiteral(["\n  fragment Erc20 on Erc20 {\n    __typename\n    name\n    symbol\n    decimals\n    address\n  }\n"])));
var Erc20AmountFragmentDoc = gql__default["default"](_templateObject3$b || (_templateObject3$b = _taggedTemplateLiteral(["\n  fragment Erc20Amount on Erc20Amount {\n    __typename\n    asset {\n      ...Erc20\n    }\n    value\n  }\n  ", "\n"])), Erc20FragmentDoc);
var MediaFragmentDoc = gql__default["default"](_templateObject4$a || (_templateObject4$a = _taggedTemplateLiteral(["\n  fragment Media on Media {\n    __typename\n    altTag\n    cover\n    mimeType\n    url\n  }\n"])));
var ProfilePictureSetFragmentDoc = gql__default["default"](_templateObject5$9 || (_templateObject5$9 = _taggedTemplateLiteral(["\n  fragment ProfilePictureSet on MediaSet {\n    __typename\n    onChain {\n      ...Media\n    }\n    original {\n      ...Media\n    }\n    optimized {\n      ...Media\n    }\n    transformed(params: $mediaTransformProfilePicture) {\n      ...Media\n    }\n  }\n  ", "\n"])), MediaFragmentDoc);
var ProfileCoverSetFragmentDoc = gql__default["default"](_templateObject6$6 || (_templateObject6$6 = _taggedTemplateLiteral(["\n  fragment ProfileCoverSet on MediaSet {\n    __typename\n    onChain {\n      ...Media\n    }\n    original {\n      ...Media\n    }\n    optimized {\n      ...Media\n    }\n    transformed(params: $mediaTransformProfileCover) {\n      ...Media\n    }\n  }\n  ", "\n"])), MediaFragmentDoc);
var ModuleFeeAmountFragmentDoc = gql__default["default"](_templateObject7$6 || (_templateObject7$6 = _taggedTemplateLiteral(["\n  fragment ModuleFeeAmount on ModuleFeeAmount {\n    __typename\n    asset {\n      ...Erc20\n    }\n    value\n  }\n  ", "\n"])), Erc20FragmentDoc);
var FeeFollowModuleSettingsFragmentDoc = gql__default["default"](_templateObject8$4 || (_templateObject8$4 = _taggedTemplateLiteral(["\n  fragment FeeFollowModuleSettings on FeeFollowModuleSettings {\n    __typename\n    amount {\n      ...ModuleFeeAmount\n    }\n    contractAddress\n    recipient\n  }\n  ", "\n"])), ModuleFeeAmountFragmentDoc);
var ProfileFollowModuleSettingsFragmentDoc = gql__default["default"](_templateObject9$4 || (_templateObject9$4 = _taggedTemplateLiteral(["\n  fragment ProfileFollowModuleSettings on ProfileFollowModuleSettings {\n    __typename\n    contractAddress\n  }\n"])));
var RevertFollowModuleSettingsFragmentDoc = gql__default["default"](_templateObject10$3 || (_templateObject10$3 = _taggedTemplateLiteral(["\n  fragment RevertFollowModuleSettings on RevertFollowModuleSettings {\n    __typename\n    contractAddress\n  }\n"])));
var UnknownFollowModuleSettingsFragmentDoc = gql__default["default"](_templateObject11$3 || (_templateObject11$3 = _taggedTemplateLiteral(["\n  fragment UnknownFollowModuleSettings on UnknownFollowModuleSettings {\n    __typename\n    contractAddress\n  }\n"])));
var AttributeFragmentDoc = gql__default["default"](_templateObject12$2 || (_templateObject12$2 = _taggedTemplateLiteral(["\n  fragment Attribute on Attribute {\n    __typename\n    displayType\n    key\n    value\n  }\n"])));
var ProfileFieldsFragmentDoc = gql__default["default"](_templateObject13$2 || (_templateObject13$2 = _taggedTemplateLiteral(["\n  fragment ProfileFields on Profile {\n    __typename\n    id\n    name\n    bio\n    handle\n    ownedBy\n    interests\n    picture {\n      ... on NftImage {\n        __typename\n        contractAddress\n        tokenId\n        uri\n        verified\n      }\n      ... on MediaSet {\n        ...ProfilePictureSet\n      }\n    }\n    coverPicture {\n      ... on NftImage {\n        __typename\n        contractAddress\n        tokenId\n        uri\n        verified\n      }\n      ... on MediaSet {\n        ...ProfileCoverSet\n      }\n    }\n    stats {\n      __typename\n      totalFollowers\n      totalFollowing\n      totalPosts\n    }\n    followModule {\n      ... on FeeFollowModuleSettings {\n        ...FeeFollowModuleSettings\n      }\n      ... on ProfileFollowModuleSettings {\n        ...ProfileFollowModuleSettings\n      }\n      ... on RevertFollowModuleSettings {\n        ...RevertFollowModuleSettings\n      }\n      ... on UnknownFollowModuleSettings {\n        ...UnknownFollowModuleSettings\n      }\n    }\n    attributes {\n      ...Attribute\n    }\n    dispatcher {\n      address\n      canUseRelay\n    }\n    isDefault\n    isFollowedByMe(isFinalisedOnChain: true)\n    isFollowing(who: $observerId)\n  }\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"])), ProfilePictureSetFragmentDoc, ProfileCoverSetFragmentDoc, FeeFollowModuleSettingsFragmentDoc, ProfileFollowModuleSettingsFragmentDoc, RevertFollowModuleSettingsFragmentDoc, UnknownFollowModuleSettingsFragmentDoc, AttributeFragmentDoc);
var ProfileFragmentDoc = gql__default["default"](_templateObject14$2 || (_templateObject14$2 = _taggedTemplateLiteral(["\n  fragment Profile on Profile {\n    ...ProfileFields\n    invitedBy {\n      ...ProfileFields\n    }\n  }\n  ", "\n"])), ProfileFieldsFragmentDoc);
var MirrorBaseFragmentDoc = gql__default["default"](_templateObject15$2 || (_templateObject15$2 = _taggedTemplateLiteral(["\n  fragment MirrorBase on Mirror {\n    __typename\n    id\n    createdAt\n    isDataAvailability\n    dataAvailabilityProofs\n    profile {\n      ...Profile\n    }\n    hidden\n  }\n  ", "\n"])), ProfileFragmentDoc);
var SimplePublicationStatsFragmentDoc = gql__default["default"](_templateObject16$2 || (_templateObject16$2 = _taggedTemplateLiteral(["\n  fragment SimplePublicationStats on PublicationStats {\n    __typename\n    totalAmountOfMirrors\n    totalAmountOfCollects\n    totalAmountOfComments\n    totalUpvotes\n    totalDownvotes\n    totalBookmarks\n  }\n"])));
var PublicationMediaSetFragmentDoc = gql__default["default"](_templateObject17$2 || (_templateObject17$2 = _taggedTemplateLiteral(["\n  fragment PublicationMediaSet on MediaSet {\n    __typename\n    onChain {\n      ...Media\n    }\n    original {\n      ...Media\n    }\n    optimized {\n      ...Media\n    }\n    transformed(params: $mediaTransformPublication) {\n      ...Media\n    }\n  }\n  ", "\n"])), MediaFragmentDoc);
var MetadataAttributeOutputFragmentDoc = gql__default["default"](_templateObject18$2 || (_templateObject18$2 = _taggedTemplateLiteral(["\n  fragment MetadataAttributeOutput on MetadataAttributeOutput {\n    __typename\n    traitType\n    value\n  }\n"])));
var MetadataFragmentDoc = gql__default["default"](_templateObject19$2 || (_templateObject19$2 = _taggedTemplateLiteral(["\n  fragment Metadata on MetadataOutput {\n    __typename\n    animatedUrl\n    content\n    contentWarning\n    description\n    image\n    locale\n    mainContentFocus\n    name\n    media {\n      ...PublicationMediaSet\n    }\n    attributes {\n      ...MetadataAttributeOutput\n    }\n    tags\n  }\n  ", "\n  ", "\n"])), PublicationMediaSetFragmentDoc, MetadataAttributeOutputFragmentDoc);
var WalletFragmentDoc = gql__default["default"](_templateObject20$2 || (_templateObject20$2 = _taggedTemplateLiteral(["\n  fragment Wallet on Wallet {\n    __typename\n    address\n    defaultProfile {\n      ...Profile\n    }\n  }\n  ", "\n"])), ProfileFragmentDoc);
var FreeCollectModuleSettingsFragmentDoc = gql__default["default"](_templateObject21$2 || (_templateObject21$2 = _taggedTemplateLiteral(["\n  fragment FreeCollectModuleSettings on FreeCollectModuleSettings {\n    __typename\n    contractAddress\n    followerOnly\n  }\n"])));
var FeeCollectModuleSettingsFragmentDoc = gql__default["default"](_templateObject22$2 || (_templateObject22$2 = _taggedTemplateLiteral(["\n  fragment FeeCollectModuleSettings on FeeCollectModuleSettings {\n    __typename\n    amount {\n      ...ModuleFeeAmount\n    }\n    contractAddress\n    followerOnly\n    recipient\n    referralFee\n  }\n  ", "\n"])), ModuleFeeAmountFragmentDoc);
var LimitedFeeCollectModuleSettingsFragmentDoc = gql__default["default"](_templateObject23$2 || (_templateObject23$2 = _taggedTemplateLiteral(["\n  fragment LimitedFeeCollectModuleSettings on LimitedFeeCollectModuleSettings {\n    __typename\n    amount {\n      ...ModuleFeeAmount\n    }\n    collectLimit\n    contractAddress\n    followerOnly\n    recipient\n    referralFee\n  }\n  ", "\n"])), ModuleFeeAmountFragmentDoc);
var LimitedTimedFeeCollectModuleSettingsFragmentDoc = gql__default["default"](_templateObject24$2 || (_templateObject24$2 = _taggedTemplateLiteral(["\n  fragment LimitedTimedFeeCollectModuleSettings on LimitedTimedFeeCollectModuleSettings {\n    __typename\n    amount {\n      ...ModuleFeeAmount\n    }\n    collectLimit\n    contractAddress\n    followerOnly\n    endTimestamp\n    recipient\n    referralFee\n  }\n  ", "\n"])), ModuleFeeAmountFragmentDoc);
var RevertCollectModuleSettingsFragmentDoc = gql__default["default"](_templateObject25$2 || (_templateObject25$2 = _taggedTemplateLiteral(["\n  fragment RevertCollectModuleSettings on RevertCollectModuleSettings {\n    __typename\n    contractAddress\n  }\n"])));
var TimedFeeCollectModuleSettingsFragmentDoc = gql__default["default"](_templateObject26$2 || (_templateObject26$2 = _taggedTemplateLiteral(["\n  fragment TimedFeeCollectModuleSettings on TimedFeeCollectModuleSettings {\n    __typename\n    amount {\n      ...ModuleFeeAmount\n    }\n    contractAddress\n    followerOnly\n    endTimestamp\n    recipient\n    referralFee\n  }\n  ", "\n"])), ModuleFeeAmountFragmentDoc);
var MultirecipientFeeCollectModuleSettingsFragmentDoc = gql__default["default"](_templateObject27$2 || (_templateObject27$2 = _taggedTemplateLiteral(["\n  fragment MultirecipientFeeCollectModuleSettings on MultirecipientFeeCollectModuleSettings {\n    __typename\n    amount {\n      ...ModuleFeeAmount\n    }\n    collectLimitOptional: collectLimit\n    contractAddress\n    followerOnly\n    endTimestampOptional: endTimestamp\n    recipients {\n      recipient\n      split\n    }\n    referralFee\n  }\n  ", "\n"])), ModuleFeeAmountFragmentDoc);
var Erc4626FeeCollectModuleSettingsFragmentDoc = gql__default["default"](_templateObject28$2 || (_templateObject28$2 = _taggedTemplateLiteral(["\n  fragment ERC4626FeeCollectModuleSettings on ERC4626FeeCollectModuleSettings {\n    __typename\n    amount {\n      ...ModuleFeeAmount\n    }\n    collectLimitOptional: collectLimit\n    contractAddress\n    followerOnly\n    endTimestampOptional: endTimestamp\n    recipient\n    referralFee\n    vault\n  }\n  ", "\n"])), ModuleFeeAmountFragmentDoc);
var AaveFeeCollectModuleSettingsFragmentDoc = gql__default["default"](_templateObject29$2 || (_templateObject29$2 = _taggedTemplateLiteral(["\n  fragment AaveFeeCollectModuleSettings on AaveFeeCollectModuleSettings {\n    __typename\n    amount {\n      ...ModuleFeeAmount\n    }\n    collectLimitOptional: collectLimit\n    contractAddress\n    followerOnly\n    endTimestampOptional: endTimestamp\n    recipient\n    referralFee\n  }\n  ", "\n"])), ModuleFeeAmountFragmentDoc);
var SimpleCollectModuleSettingsFragmentDoc = gql__default["default"](_templateObject30$2 || (_templateObject30$2 = _taggedTemplateLiteral(["\n  fragment SimpleCollectModuleSettings on SimpleCollectModuleSettings {\n    __typename\n    contractAddress\n    followerOnly\n    feeOptional: fee {\n      amount {\n        ...ModuleFeeAmount\n      }\n      referralFee\n      recipient\n    }\n    collectLimitOptional: collectLimit\n    endTimestampOptional: endTimestamp\n  }\n  ", "\n"])), ModuleFeeAmountFragmentDoc);
var PostFragmentDoc = gql__default["default"](_templateObject31$1 || (_templateObject31$1 = _taggedTemplateLiteral(["\n  fragment Post on Post {\n    __typename\n    id\n    appId\n    stats {\n      ...SimplePublicationStats\n    }\n    metadata {\n      ...Metadata\n    }\n    profile {\n      ...Profile\n    }\n    collectedBy {\n      ...Wallet\n    }\n    collectModule {\n      __typename\n      ... on FreeCollectModuleSettings {\n        ...FreeCollectModuleSettings\n      }\n      ... on FeeCollectModuleSettings {\n        ...FeeCollectModuleSettings\n      }\n      ... on LimitedFeeCollectModuleSettings {\n        ...LimitedFeeCollectModuleSettings\n      }\n      ... on LimitedTimedFeeCollectModuleSettings {\n        ...LimitedTimedFeeCollectModuleSettings\n      }\n      ... on RevertCollectModuleSettings {\n        ...RevertCollectModuleSettings\n      }\n      ... on TimedFeeCollectModuleSettings {\n        ...TimedFeeCollectModuleSettings\n      }\n      ... on MultirecipientFeeCollectModuleSettings {\n        ...MultirecipientFeeCollectModuleSettings\n      }\n      ... on ERC4626FeeCollectModuleSettings {\n        ...ERC4626FeeCollectModuleSettings\n      }\n      ... on AaveFeeCollectModuleSettings {\n        ...AaveFeeCollectModuleSettings\n      }\n      ... on SimpleCollectModuleSettings {\n        ...SimpleCollectModuleSettings\n      }\n    }\n    referenceModule {\n      __typename\n      ... on FollowOnlyReferenceModuleSettings {\n        contractAddress\n      }\n    }\n    collectNftAddress\n    createdAt\n    hidden\n    bookmarked(by: $observerId)\n    isGated\n    isDataAvailability\n    dataAvailabilityProofs\n    reaction(request: { profileId: $observerId })\n    hasCollectedByMe(isFinalisedOnChain: true)\n    canComment(profileId: $observerId) {\n      result\n    }\n    canMirror(profileId: $observerId) {\n      result\n    }\n    mirrors(by: $observerId)\n  }\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"])), SimplePublicationStatsFragmentDoc, MetadataFragmentDoc, ProfileFragmentDoc, WalletFragmentDoc, FreeCollectModuleSettingsFragmentDoc, FeeCollectModuleSettingsFragmentDoc, LimitedFeeCollectModuleSettingsFragmentDoc, LimitedTimedFeeCollectModuleSettingsFragmentDoc, RevertCollectModuleSettingsFragmentDoc, TimedFeeCollectModuleSettingsFragmentDoc, MultirecipientFeeCollectModuleSettingsFragmentDoc, Erc4626FeeCollectModuleSettingsFragmentDoc, AaveFeeCollectModuleSettingsFragmentDoc, SimpleCollectModuleSettingsFragmentDoc);
var CommentBaseFragmentDoc = gql__default["default"](_templateObject32$1 || (_templateObject32$1 = _taggedTemplateLiteral(["\n  fragment CommentBase on Comment {\n    __typename\n    id\n    appId\n    stats {\n      ...SimplePublicationStats\n    }\n    metadata {\n      ...Metadata\n    }\n    profile {\n      ...Profile\n    }\n    collectedBy {\n      ...Wallet\n    }\n    collectModule {\n      __typename\n      ... on FreeCollectModuleSettings {\n        ...FreeCollectModuleSettings\n      }\n      ... on FeeCollectModuleSettings {\n        ...FeeCollectModuleSettings\n      }\n      ... on LimitedFeeCollectModuleSettings {\n        ...LimitedFeeCollectModuleSettings\n      }\n      ... on LimitedTimedFeeCollectModuleSettings {\n        ...LimitedTimedFeeCollectModuleSettings\n      }\n      ... on RevertCollectModuleSettings {\n        ...RevertCollectModuleSettings\n      }\n      ... on TimedFeeCollectModuleSettings {\n        ...TimedFeeCollectModuleSettings\n      }\n      ... on MultirecipientFeeCollectModuleSettings {\n        ...MultirecipientFeeCollectModuleSettings\n      }\n      ... on ERC4626FeeCollectModuleSettings {\n        ...ERC4626FeeCollectModuleSettings\n      }\n      ... on AaveFeeCollectModuleSettings {\n        ...AaveFeeCollectModuleSettings\n      }\n      ... on SimpleCollectModuleSettings {\n        ...SimpleCollectModuleSettings\n      }\n    }\n    referenceModule {\n      __typename\n      ... on FollowOnlyReferenceModuleSettings {\n        contractAddress\n      }\n    }\n    collectNftAddress\n    createdAt\n    hidden\n    bookmarked(by: $observerId)\n    isGated\n    isDataAvailability\n    dataAvailabilityProofs\n    reaction(request: { profileId: $observerId })\n    hasCollectedByMe(isFinalisedOnChain: true)\n    canComment(profileId: $observerId) {\n      result\n    }\n    canMirror(profileId: $observerId) {\n      result\n    }\n    mirrors(by: $observerId)\n  }\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"])), SimplePublicationStatsFragmentDoc, MetadataFragmentDoc, ProfileFragmentDoc, WalletFragmentDoc, FreeCollectModuleSettingsFragmentDoc, FeeCollectModuleSettingsFragmentDoc, LimitedFeeCollectModuleSettingsFragmentDoc, LimitedTimedFeeCollectModuleSettingsFragmentDoc, RevertCollectModuleSettingsFragmentDoc, TimedFeeCollectModuleSettingsFragmentDoc, MultirecipientFeeCollectModuleSettingsFragmentDoc, Erc4626FeeCollectModuleSettingsFragmentDoc, AaveFeeCollectModuleSettingsFragmentDoc, SimpleCollectModuleSettingsFragmentDoc);
var CommentFragmentDoc = gql__default["default"](_templateObject33$1 || (_templateObject33$1 = _taggedTemplateLiteral(["\n  fragment Comment on Comment {\n    __typename\n    ...CommentBase\n    commentOn {\n      ... on Post {\n        ...Post\n      }\n      ... on Mirror {\n        ...MirrorBase\n      }\n      ... on Comment {\n        ...CommentBase\n      }\n    }\n    mainPost {\n      ... on Post {\n        ...Post\n      }\n      ... on Mirror {\n        ...MirrorBase\n      }\n    }\n  }\n  ", "\n  ", "\n  ", "\n"])), CommentBaseFragmentDoc, PostFragmentDoc, MirrorBaseFragmentDoc);
var MirrorFragmentDoc = gql__default["default"](_templateObject34$1 || (_templateObject34$1 = _taggedTemplateLiteral(["\n  fragment Mirror on Mirror {\n    __typename\n    ...MirrorBase\n    mirrorOf {\n      ... on Post {\n        ...Post\n      }\n      ... on Comment {\n        ...Comment\n      }\n    }\n  }\n  ", "\n  ", "\n  ", "\n"])), MirrorBaseFragmentDoc, PostFragmentDoc, CommentFragmentDoc);
var CommonPaginatedResultInfoFragmentDoc = gql__default["default"](_templateObject35$1 || (_templateObject35$1 = _taggedTemplateLiteral(["\n  fragment CommonPaginatedResultInfo on PaginatedResultInfo {\n    __typename\n    prev\n    next\n    totalCount\n  }\n"])));
var FollowingFragmentDoc = gql__default["default"](_templateObject36$1 || (_templateObject36$1 = _taggedTemplateLiteral(["\n  fragment Following on Following {\n    __typename\n    profile {\n      ...Profile\n    }\n  }\n  ", "\n"])), ProfileFragmentDoc);
var FollowerFragmentDoc = gql__default["default"](_templateObject37$1 || (_templateObject37$1 = _taggedTemplateLiteral(["\n  fragment Follower on Follower {\n    __typename\n    wallet {\n      ...Wallet\n    }\n  }\n  ", "\n"])), WalletFragmentDoc);
var RelayerResultFragmentDoc = gql__default["default"](_templateObject38$1 || (_templateObject38$1 = _taggedTemplateLiteral(["\n  fragment RelayerResult on RelayerResult {\n    __typename\n    txHash\n    txId\n  }\n"])));
var RelayErrorFragmentDoc = gql__default["default"](_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["\n  fragment RelayError on RelayError {\n    __typename\n    reason\n  }\n"])));
var CreateDataAvailabilityPublicationResultFragmentDoc = gql__default["default"](_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["\n  fragment CreateDataAvailabilityPublicationResult on CreateDataAvailabilityPublicationResult {\n    __typename\n    id\n    proofs\n    dataAvailabilityId\n  }\n"])));

var _templateObject$e, _templateObject2$e, _templateObject3$a;
var PublicationsProfileBookmarksDocument = gql__default["default"](_templateObject$e || (_templateObject$e = _taggedTemplateLiteral(["\n  query PublicationsProfileBookmarks(\n    $request: PublicationsProfileBookmarkedQueryRequest!\n    $observerId: ProfileId\n    $mediaTransformPublication: MediaTransformParams = {}\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: publicationsProfileBookmarks(request: $request) {\n      items {\n        ... on Post {\n          ...Post\n        }\n        ... on Comment {\n          ...Comment\n        }\n        ... on Mirror {\n          ...Mirror\n        }\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n  ", "\n  ", "\n"])), PostFragmentDoc, CommentFragmentDoc, MirrorFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var AddPublicationProfileBookmarkDocument = gql__default["default"](_templateObject2$e || (_templateObject2$e = _taggedTemplateLiteral(["\n  mutation AddPublicationProfileBookmark($request: PublicationProfileBookmarkRequest!) {\n    result: addPublicationProfileBookmark(request: $request)\n  }\n"])));
var RemovePublicationProfileBookmarkDocument = gql__default["default"](_templateObject3$a || (_templateObject3$a = _taggedTemplateLiteral(["\n  mutation RemovePublicationProfileBookmark($request: PublicationProfileBookmarkRequest!) {\n    result: removePublicationProfileBookmark(request: $request)\n  }\n"])));
var defaultWrapper$e = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var PublicationsProfileBookmarksDocumentString = graphql.print(PublicationsProfileBookmarksDocument);
var AddPublicationProfileBookmarkDocumentString = graphql.print(AddPublicationProfileBookmarkDocument);
var RemovePublicationProfileBookmarkDocumentString = graphql.print(RemovePublicationProfileBookmarkDocument);
function getSdk$e(client) {
  var withWrapper = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultWrapper$e;
  return {
    PublicationsProfileBookmarks: function PublicationsProfileBookmarks(variables, requestHeaders) {
      return withWrapper(function (wrappedRequestHeaders) {
        return client.rawRequest(PublicationsProfileBookmarksDocumentString, variables, _objectSpread2(_objectSpread2({}, requestHeaders), wrappedRequestHeaders));
      }, 'PublicationsProfileBookmarks', 'query');
    },
    AddPublicationProfileBookmark: function AddPublicationProfileBookmark(variables, requestHeaders) {
      return withWrapper(function (wrappedRequestHeaders) {
        return client.rawRequest(AddPublicationProfileBookmarkDocumentString, variables, _objectSpread2(_objectSpread2({}, requestHeaders), wrappedRequestHeaders));
      }, 'AddPublicationProfileBookmark', 'mutation');
    },
    RemovePublicationProfileBookmark: function RemovePublicationProfileBookmark(variables, requestHeaders) {
      return withWrapper(function (wrappedRequestHeaders) {
        return client.rawRequest(RemovePublicationProfileBookmarkDocumentString, variables, _objectSpread2(_objectSpread2({}, requestHeaders), wrappedRequestHeaders));
      }, 'RemovePublicationProfileBookmark', 'mutation');
    }
  };
}
...
var Bookmarks = /*#__PURE__*/function () {
  function Bookmarks(config, authentication) {
  ...
  _createClass(Bookmarks, [{
                          ...
                          var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(currRequest) {
                            ...
                            return _regeneratorRuntime().wrap(function _callee$(_context) {
                              while (1) switch (_context.prev = _context.next) {
                                case 0:
                                  _context.next = 2;
                                  return _this.sdk.PublicationsProfileBookmarks(_objectSpread2({
                                    request: currRequest,
                                    observerId: observerId
                                  }, buildMediaTransformsFromConfig(_this.config.mediaTransforms)), headers);
                                case 2:
                                  result = _context.sent;
    ...
    key: "add",
    value: function () {
      var _add = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(request) {
        var _this2 = this;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
                ...
                var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(headers) {
                  return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                    while (1) switch (_context4.prev = _context4.next) {
                      case 0:
                        _context4.next = 2;
                        return _this2.sdk.AddPublicationProfileBookmark({
                          request: request
                        }, headers);
                      case 2:
                      case "end":
    ...
    key: "remove",
    value: function () {
      var _remove = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(request) {
        var _this3 = this;
                ...
                var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(headers) {
                  return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                    while (1) switch (_context6.prev = _context6.next) {
                      case 0:
                        _context6.next = 2;
                        return _this3.sdk.RemovePublicationProfileBookmark({
                          request: request
                        }, headers);
                      case 2:
                      case "end":
...
var ExplorePublicationsDocument = gql__default["default"](_templateObject$d || (_templateObject$d = _taggedTemplateLiteral(["\n  query ExplorePublications(\n    $request: ExplorePublicationRequest!\n    $observerId: ProfileId\n    $mediaTransformPublication: MediaTransformParams = {}\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: explorePublications(request: $request) {\n      items {\n        ... on Post {\n          ...Post\n        }\n        ... on Mirror {\n          ...Mirror\n        }\n        ... on Comment {\n          ...Comment\n        }\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n  ", "\n  ", "\n"])), PostFragmentDoc, MirrorFragmentDoc, CommentFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var ExploreProfilesDocument = gql__default["default"](_templateObject2$d || (_templateObject2$d = _taggedTemplateLiteral(["\n  query ExploreProfiles(\n    $request: ExploreProfilesRequest!\n    $observerId: ProfileId\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: exploreProfiles(request: $request) {\n      items {\n        ...Profile\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n"])), ProfileFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var defaultWrapper$d = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var ExplorePublicationsDocumentString = graphql.print(ExplorePublicationsDocument);
var ExploreProfilesDocumentString = graphql.print(ExploreProfilesDocument);
                              ...
                              while (1) switch (_context4.prev = _context4.next) {
                                case 0:
                                  ...
                                  return _this2.sdk.ExploreProfiles(_objectSpread2({
                                    request: currRequest,
                                    observerId: observerId
                                  }, buildMediaTransformsFromConfig(_this2.config.mediaTransforms)), headers);
                                case 2:
                                  result = _context4.sent;
...
var ElectedMirrorFragmentDoc = gql__default["default"](_templateObject$c || (_templateObject$c = _taggedTemplateLiteral(["\n  fragment ElectedMirror on ElectedMirror {\n    __typename\n    mirrorId\n    profile {\n      ...Profile\n    }\n    timestamp\n  }\n  ", "\n"])), ProfileFragmentDoc);
var MirrorEventFragmentDoc = gql__default["default"](_templateObject2$c || (_templateObject2$c = _taggedTemplateLiteral(["\n  fragment MirrorEvent on MirrorEvent {\n    __typename\n    profile {\n      ...Profile\n    }\n    timestamp\n  }\n  ", "\n"])), ProfileFragmentDoc);
var CollectedEventFragmentDoc = gql__default["default"](_templateObject3$9 || (_templateObject3$9 = _taggedTemplateLiteral(["\n  fragment CollectedEvent on CollectedEvent {\n    __typename\n    profile {\n      ...Profile\n    }\n    timestamp\n  }\n  ", "\n"])), ProfileFragmentDoc);
var ReactionEventFragmentDoc = gql__default["default"](_templateObject4$9 || (_templateObject4$9 = _taggedTemplateLiteral(["\n  fragment ReactionEvent on ReactionEvent {\n    __typename\n    profile {\n      ...Profile\n    }\n    reaction\n    timestamp\n  }\n  ", "\n"])), ProfileFragmentDoc);
var FeedItemFragmentDoc = gql__default["default"](_templateObject5$8 || (_templateObject5$8 = _taggedTemplateLiteral(["\n  fragment FeedItem on FeedItem {\n    __typename\n    root {\n      ... on Post {\n        ...Post\n      }\n      ... on Comment {\n        ...Comment\n      }\n    }\n    comments {\n      ...Comment\n    }\n    electedMirror {\n      ...ElectedMirror\n    }\n    mirrors {\n      ...MirrorEvent\n    }\n    collects {\n      ...CollectedEvent\n    }\n    reactions {\n      ...ReactionEvent\n    }\n  }\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"])), PostFragmentDoc, CommentFragmentDoc, ElectedMirrorFragmentDoc, MirrorEventFragmentDoc, CollectedEventFragmentDoc, ReactionEventFragmentDoc);
var FeedDocument = gql__default["default"](_templateObject6$5 || (_templateObject6$5 = _taggedTemplateLiteral(["\n  query Feed(\n    $request: FeedRequest!\n    $observerId: ProfileId\n    $mediaTransformPublication: MediaTransformParams = {}\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: feed(request: $request) {\n      items {\n        ...FeedItem\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n"])), FeedItemFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var FeedHighlightsDocument = gql__default["default"](_templateObject7$5 || (_templateObject7$5 = _taggedTemplateLiteral(["\n  query FeedHighlights(\n    $request: FeedHighlightsRequest!\n    $observerId: ProfileId\n    $mediaTransformPublication: MediaTransformParams = {}\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: feedHighlights(request: $request) {\n      items {\n        ... on Post {\n          ...Post\n        }\n        ... on Mirror {\n          ...Mirror\n        }\n        ... on Comment {\n          ...Comment\n        }\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n  ", "\n  ", "\n"])), PostFragmentDoc, MirrorFragmentDoc, CommentFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var defaultWrapper$c = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var FeedDocumentString = graphql.print(FeedDocument);
var FeedHighlightsDocumentString = graphql.print(FeedHighlightsDocument);
...
var ModuleInfoFragmentDoc = gql__default["default"](_templateObject$b || (_templateObject$b = _taggedTemplateLiteral(["\n  fragment ModuleInfo on ModuleInfo {\n    __typename\n    name\n    type\n  }\n"])));
var EnabledModuleFragmentDoc = gql__default["default"](_templateObject2$b || (_templateObject2$b = _taggedTemplateLiteral(["\n  fragment EnabledModule on EnabledModule {\n    __typename\n    moduleName\n    contractAddress\n    inputParams {\n      ...ModuleInfo\n    }\n    redeemParams {\n      ...ModuleInfo\n    }\n    returnDataParams: returnDataParms {\n      ...ModuleInfo\n    }\n  }\n  ", "\n"])), ModuleInfoFragmentDoc);
var EnabledModulesFragmentDoc = gql__default["default"](_templateObject3$8 || (_templateObject3$8 = _taggedTemplateLiteral(["\n  fragment EnabledModules on EnabledModules {\n    __typename\n    collectModules {\n      ...EnabledModule\n    }\n    followModules {\n      ...EnabledModule\n    }\n    referenceModules {\n      ...EnabledModule\n    }\n  }\n  ", "\n"])), EnabledModuleFragmentDoc);
var ApprovedAllowanceAmountFragmentDoc = gql__default["default"](_templateObject4$8 || (_templateObject4$8 = _taggedTemplateLiteral(["\n  fragment ApprovedAllowanceAmount on ApprovedAllowanceAmount {\n    currency\n    module\n    contractAddress\n    allowance\n  }\n"])));
var GenerateModuleCurrencyApprovalFragmentDoc = gql__default["default"](_templateObject5$7 || (_templateObject5$7 = _taggedTemplateLiteral(["\n  fragment GenerateModuleCurrencyApproval on GenerateModuleCurrencyApproval {\n    to\n    from\n    data\n  }\n"])));
var EnabledModulesDocument = gql__default["default"](_templateObject6$4 || (_templateObject6$4 = _taggedTemplateLiteral(["\n  query EnabledModules {\n    result: enabledModules {\n      ...EnabledModules\n    }\n  }\n  ", "\n"])), EnabledModulesFragmentDoc);
var EnabledModuleCurrenciesDocument = gql__default["default"](_templateObject7$4 || (_templateObject7$4 = _taggedTemplateLiteral(["\n  query EnabledModuleCurrencies {\n    result: enabledModuleCurrencies {\n      ...Erc20\n    }\n  }\n  ", "\n"])), Erc20FragmentDoc);
var ApprovedModuleAllowanceAmountDocument = gql__default["default"](_templateObject8$3 || (_templateObject8$3 = _taggedTemplateLiteral(["\n  query ApprovedModuleAllowanceAmount($request: ApprovedModuleAllowanceAmountRequest!) {\n    result: approvedModuleAllowanceAmount(request: $request) {\n      ... on ApprovedAllowanceAmount {\n        ...ApprovedAllowanceAmount\n      }\n    }\n  }\n  ", "\n"])), ApprovedAllowanceAmountFragmentDoc);
var GenerateModuleCurrencyApprovalDataDocument = gql__default["default"](_templateObject9$3 || (_templateObject9$3 = _taggedTemplateLiteral(["\n  query GenerateModuleCurrencyApprovalData($request: GenerateModuleCurrencyApprovalDataRequest!) {\n    result: generateModuleCurrencyApprovalData(request: $request) {\n      ... on GenerateModuleCurrencyApproval {\n        ...GenerateModuleCurrencyApproval\n      }\n    }\n  }\n  ", "\n"])), GenerateModuleCurrencyApprovalFragmentDoc);
var defaultWrapper$b = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var EnabledModulesDocumentString = graphql.print(EnabledModulesDocument);
var EnabledModuleCurrenciesDocumentString = graphql.print(EnabledModuleCurrenciesDocument);
var ApprovedModuleAllowanceAmountDocumentString = graphql.print(ApprovedModuleAllowanceAmountDocument);
var GenerateModuleCurrencyApprovalDataDocumentString = graphql.print(GenerateModuleCurrencyApprovalDataDocument);
...
var NftFragmentDoc = gql__default["default"](_templateObject$a || (_templateObject$a = _taggedTemplateLiteral(["\n  fragment Nft on NFT {\n    __typename\n    contractName\n    contractAddress\n    symbol\n    tokenId\n    owners {\n      amount\n      address\n    }\n    name\n    description\n    contentURI\n    originalContent {\n      uri\n      animatedUrl\n      metaType\n    }\n    chainId\n    collectionName\n    ercType\n  }\n"])));
var NftGalleryFragmentDoc = gql__default["default"](_templateObject2$a || (_templateObject2$a = _taggedTemplateLiteral(["\n  fragment NftGallery on NftGallery {\n    id\n    name\n    profileId\n    createdAt\n    updatedAt\n    items {\n      ...Nft\n    }\n  }\n  ", "\n"])), NftFragmentDoc);
var NftOwnershipChallengeResultFragmentDoc = gql__default["default"](_templateObject3$7 || (_templateObject3$7 = _taggedTemplateLiteral(["\n  fragment NftOwnershipChallengeResult on NftOwnershipChallengeResult {\n    id\n    text\n    timeout\n  }\n"])));
var NftsDocument = gql__default["default"](_templateObject4$7 || (_templateObject4$7 = _taggedTemplateLiteral(["\n  query Nfts($request: NFTsRequest!) {\n    result: nfts(request: $request) {\n      items {\n        ...Nft\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n"])), NftFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var NftOwnershipChallengeDocument = gql__default["default"](_templateObject5$6 || (_templateObject5$6 = _taggedTemplateLiteral(["\n  query NftOwnershipChallenge($request: NftOwnershipChallengeRequest!) {\n    result: nftOwnershipChallenge(request: $request) {\n      ...NftOwnershipChallengeResult\n    }\n  }\n  ", "\n"])), NftOwnershipChallengeResultFragmentDoc);
var ProfileGalleriesDocument = gql__default["default"](_templateObject6$3 || (_templateObject6$3 = _taggedTemplateLiteral(["\n  query ProfileGalleries($request: NftGalleriesRequest!) {\n    result: nftGalleries(request: $request) {\n      ...NftGallery\n    }\n  }\n  ", "\n"])), NftGalleryFragmentDoc);
var CreateNftGalleryDocument = gql__default["default"](_templateObject7$3 || (_templateObject7$3 = _taggedTemplateLiteral(["\n  mutation CreateNFTGallery($request: NftGalleryCreateRequest!) {\n    result: createNftGallery(request: $request)\n  }\n"])));
var UpdateNftGalleryInfoDocument = gql__default["default"](_templateObject8$2 || (_templateObject8$2 = _taggedTemplateLiteral(["\n  mutation UpdateNFTGalleryInfo($request: NftGalleryUpdateInfoRequest!) {\n    updateNftGalleryInfo(request: $request)\n  }\n"])));
var UpdateNftGalleryOrderDocument = gql__default["default"](_templateObject9$2 || (_templateObject9$2 = _taggedTemplateLiteral(["\n  mutation UpdateNFTGalleryOrder($request: NftGalleryUpdateItemOrderRequest!) {\n    updateNftGalleryOrder(request: $request)\n  }\n"])));
var UpdateNftGalleryItemsDocument = gql__default["default"](_templateObject10$2 || (_templateObject10$2 = _taggedTemplateLiteral(["\n  mutation UpdateNFTGalleryItems($request: NftGalleryUpdateItemsRequest!) {\n    updateNftGalleryItems(request: $request)\n  }\n"])));
var DeleteNftGalleryDocument = gql__default["default"](_templateObject11$2 || (_templateObject11$2 = _taggedTemplateLiteral(["\n  mutation DeleteNFTGallery($request: NftGalleryDeleteRequest!) {\n    deleteNftGallery(request: $request)\n  }\n"])));
var defaultWrapper$a = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var NftsDocumentString = graphql.print(NftsDocument);
var NftOwnershipChallengeDocumentString = graphql.print(NftOwnershipChallengeDocument);
var ProfileGalleriesDocumentString = graphql.print(ProfileGalleriesDocument);
var CreateNftGalleryDocumentString = graphql.print(CreateNftGalleryDocument);
var UpdateNftGalleryInfoDocumentString = graphql.print(UpdateNftGalleryInfoDocument);
var UpdateNftGalleryOrderDocumentString = graphql.print(UpdateNftGalleryOrderDocument);
var UpdateNftGalleryItemsDocumentString = graphql.print(UpdateNftGalleryItemsDocument);
var DeleteNftGalleryDocumentString = graphql.print(DeleteNftGalleryDocument);
...
var UserSigNoncesFragmentDoc = gql__default["default"](_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteral(["\n  fragment UserSigNonces on UserSigNonces {\n    lensHubOnChainSigNonce\n    peripheryOnChainSigNonce\n  }\n"])));
var UserSigNoncesDocument = gql__default["default"](_templateObject2$9 || (_templateObject2$9 = _taggedTemplateLiteral(["\n  query UserSigNonces {\n    result: userSigNonces {\n      ...UserSigNonces\n    }\n  }\n  ", "\n"])), UserSigNoncesFragmentDoc);
var defaultWrapper$9 = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var UserSigNoncesDocumentString = graphql.print(UserSigNoncesDocument);
...
var _templateObject$7, _templateObject2$7, _templateObject3$5, _templateObject4$5, _templateObject5$4, _templateObject6$1, _templateObject7$1, _templateObject8$1, _templateObject9$1, _templateObject10$1, _templateObject11$1, _templateObject12$1, _templateObject13$1, _templateObject14$1, _templateObject15$1, _templateObject16$1, _templateObject17$1, _templateObject18$1, _templateObject19$1, _templateObject20$1, _templateObject21$1, _templateObject22$1, _templateObject23$1, _templateObject24$1, _templateObject25$1, _templateObject26$1, _templateObject27$1, _templateObject28$1, _templateObject29$1, _templateObject30$1, _templateObject31, _templateObject32, _templateObject33, _templateObject34, _templateObject35, _templateObject36, _templateObject37, _templateObject38;
var ProfileStatsFragmentDoc = gql__default["default"](_templateObject$7 || (_templateObject$7 = _taggedTemplateLiteral(["\n  fragment ProfileStats on ProfileStats {\n    __typename\n    totalCollects\n    totalComments\n    totalFollowers\n    totalFollowing\n    totalMirrors\n    totalPosts\n    totalPublications\n    commentsTotal(forSources: $sources)\n    postsTotal(forSources: $sources)\n    mirrorsTotal(forSources: $sources)\n    publicationsTotal(forSources: $sources)\n  }\n"])));
var BurnProfileTypedDataFragmentDoc = gql__default["default"](_templateObject2$7 || (_templateObject2$7 = _taggedTemplateLiteral(["\n  fragment BurnProfileTypedData on CreateBurnProfileBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        BurnWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        name\n        chainId\n        version\n        verifyingContract\n      }\n      value {\n        nonce\n        deadline\n        tokenId\n      }\n    }\n  }\n"])));
var SetDefaultProfileTypedDataFragmentDoc = gql__default["default"](_templateObject3$5 || (_templateObject3$5 = _taggedTemplateLiteral(["\n  fragment SetDefaultProfileTypedData on SetDefaultProfileBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        SetDefaultProfileWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        name\n        chainId\n        version\n        verifyingContract\n      }\n      value {\n        nonce\n        deadline\n        wallet\n        profileId\n      }\n    }\n  }\n"])));
var SetProfileImageUriTypedDataFragmentDoc = gql__default["default"](_templateObject4$5 || (_templateObject4$5 = _taggedTemplateLiteral(["\n  fragment SetProfileImageURITypedData on CreateSetProfileImageUriBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        SetProfileImageURIWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        name\n        chainId\n        version\n        verifyingContract\n      }\n      value {\n        nonce\n        deadline\n        profileId\n        imageURI\n      }\n    }\n  }\n"])));
var SetProfileMetadataTypedDataFragmentDoc = gql__default["default"](_templateObject5$4 || (_templateObject5$4 = _taggedTemplateLiteral(["\n  fragment SetProfileMetadataTypedData on CreateSetProfileMetadataURIBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        SetProfileMetadataURIWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        name\n        chainId\n        version\n        verifyingContract\n      }\n      value {\n        nonce\n        deadline\n        profileId\n        metadata\n      }\n    }\n  }\n"])));
var SetDispatcherTypedDataFragmentDoc = gql__default["default"](_templateObject6$1 || (_templateObject6$1 = _taggedTemplateLiteral(["\n  fragment SetDispatcherTypedData on CreateSetDispatcherBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        SetDispatcherWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        name\n        chainId\n        version\n        verifyingContract\n      }\n      value {\n        nonce\n        deadline\n        profileId\n        dispatcher\n      }\n    }\n  }\n"])));
var FollowTypedDataFragmentDoc = gql__default["default"](_templateObject7$1 || (_templateObject7$1 = _taggedTemplateLiteral(["\n  fragment FollowTypedData on CreateFollowBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        FollowWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        ...EIP712TypedDataDomain\n      }\n      value {\n        nonce\n        deadline\n        profileIds\n        datas\n      }\n    }\n  }\n  ", "\n"])), Eip712TypedDataDomainFragmentDoc);
var UnfollowTypedDataFragmentDoc = gql__default["default"](_templateObject8$1 || (_templateObject8$1 = _taggedTemplateLiteral(["\n  fragment UnfollowTypedData on CreateUnfollowBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        BurnWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        ...EIP712TypedDataDomain\n      }\n      value {\n        nonce\n        deadline\n        tokenId\n      }\n    }\n  }\n  ", "\n"])), Eip712TypedDataDomainFragmentDoc);
var SetFollowModuleTypedDataFragmentDoc = gql__default["default"](_templateObject9$1 || (_templateObject9$1 = _taggedTemplateLiteral(["\n  fragment SetFollowModuleTypedData on CreateSetFollowModuleBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        SetFollowModuleWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        name\n        chainId\n        version\n        verifyingContract\n      }\n      value {\n        nonce\n        deadline\n        profileId\n        followModule\n        followModuleInitData\n      }\n    }\n  }\n"])));
var SetFollowNftUriTypedDataFragmentDoc = gql__default["default"](_templateObject10$1 || (_templateObject10$1 = _taggedTemplateLiteral(["\n  fragment SetFollowNFTUriTypedData on CreateSetFollowNFTUriBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        SetFollowNFTURIWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        name\n        chainId\n        version\n        verifyingContract\n      }\n      value {\n        nonce\n        profileId\n        deadline\n        followNFTURI\n      }\n    }\n  }\n"])));
var ProfileGuardianResultFragmentDoc = gql__default["default"](_templateObject11$1 || (_templateObject11$1 = _taggedTemplateLiteral(["\n  fragment ProfileGuardianResult on ProfileGuardianResult {\n    protected\n    disablingProtectionTimestamp\n  }\n"])));
var ProfileDocument = gql__default["default"](_templateObject12$1 || (_templateObject12$1 = _taggedTemplateLiteral(["\n  query Profile(\n    $request: SingleProfileQueryRequest!\n    $observerId: ProfileId\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: profile(request: $request) {\n      ...Profile\n    }\n  }\n  ", "\n"])), ProfileFragmentDoc);
var ProfileStatsDocument = gql__default["default"](_templateObject13$1 || (_templateObject13$1 = _taggedTemplateLiteral(["\n  query ProfileStats($request: SingleProfileQueryRequest!, $sources: [Sources!]!) {\n    result: profile(request: $request) {\n      stats {\n        ...ProfileStats\n      }\n    }\n  }\n  ", "\n"])), ProfileStatsFragmentDoc);
var ProfilesDocument = gql__default["default"](_templateObject14$1 || (_templateObject14$1 = _taggedTemplateLiteral(["\n  query Profiles(\n    $request: ProfileQueryRequest!\n    $observerId: ProfileId\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: profiles(request: $request) {\n      items {\n        ...Profile\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n"])), ProfileFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var RecommendedProfilesDocument = gql__default["default"](_templateObject15$1 || (_templateObject15$1 = _taggedTemplateLiteral(["\n  query RecommendedProfiles(\n    $options: RecommendedProfileOptions!\n    $observerId: ProfileId\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: recommendedProfiles(options: $options) {\n      ...Profile\n    }\n  }\n  ", "\n"])), ProfileFragmentDoc);
var MutualFollowersProfilesDocument = gql__default["default"](_templateObject16$1 || (_templateObject16$1 = _taggedTemplateLiteral(["\n  query MutualFollowersProfiles(\n    $request: MutualFollowersProfilesQueryRequest!\n    $observerId: ProfileId\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: mutualFollowersProfiles(request: $request) {\n      items {\n        ...Profile\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n"])), ProfileFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var DoesFollowDocument = gql__default["default"](_templateObject17$1 || (_templateObject17$1 = _taggedTemplateLiteral(["\n  query DoesFollow($request: DoesFollowRequest!) {\n    result: doesFollow(request: $request) {\n      follows\n      followerAddress\n      profileId\n      isFinalisedOnChain\n      __typename\n    }\n  }\n"])));
var FollowingDocument = gql__default["default"](_templateObject18$1 || (_templateObject18$1 = _taggedTemplateLiteral(["\n  query Following(\n    $request: FollowingRequest!\n    $observerId: ProfileId\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: following(request: $request) {\n      items {\n        ...Following\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n"])), FollowingFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var FollowersDocument = gql__default["default"](_templateObject19$1 || (_templateObject19$1 = _taggedTemplateLiteral(["\n  query Followers(\n    $request: FollowersRequest!\n    $observerId: ProfileId\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: followers(request: $request) {\n      items {\n        ...Follower\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n"])), FollowerFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var FollowerNftOwnedTokenIdsDocument = gql__default["default"](_templateObject20$1 || (_templateObject20$1 = _taggedTemplateLiteral(["\n  query FollowerNftOwnedTokenIds($request: FollowerNftOwnedTokenIdsRequest!) {\n    result: followerNftOwnedTokenIds(request: $request) {\n      __typename\n      followerNftAddress\n      tokensIds\n    }\n  }\n"])));
var PendingApprovalFollowsDocument = gql__default["default"](_templateObject21$1 || (_templateObject21$1 = _taggedTemplateLiteral(["\n  query PendingApprovalFollows(\n    $request: PendingApprovalFollowsRequest!\n    $observerId: ProfileId\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: pendingApprovalFollows(request: $request) {\n      items {\n        ...Profile\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n"])), ProfileFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var ProfileInterestsDocument = gql__default["default"](_templateObject22$1 || (_templateObject22$1 = _taggedTemplateLiteral(["\n  query ProfileInterests {\n    result: profileInterests\n  }\n"])));
var CreateProfileDocument = gql__default["default"](_templateObject23$1 || (_templateObject23$1 = _taggedTemplateLiteral(["\n  mutation CreateProfile($request: CreateProfileRequest!) {\n    result: createProfile(request: $request) {\n      ... on RelayerResult {\n        ...RelayerResult\n      }\n      ... on RelayError {\n        ...RelayError\n      }\n    }\n  }\n  ", "\n  ", "\n"])), RelayerResultFragmentDoc, RelayErrorFragmentDoc);
var CreateBurnProfileTypedDataDocument = gql__default["default"](_templateObject24$1 || (_templateObject24$1 = _taggedTemplateLiteral(["\n  mutation CreateBurnProfileTypedData($request: BurnProfileRequest!, $options: TypedDataOptions) {\n    result: createBurnProfileTypedData(request: $request, options: $options) {\n      ...BurnProfileTypedData\n    }\n  }\n  ", "\n"])), BurnProfileTypedDataFragmentDoc);
var CreateSetDefaultProfileTypedDataDocument = gql__default["default"](_templateObject25$1 || (_templateObject25$1 = _taggedTemplateLiteral(["\n  mutation CreateSetDefaultProfileTypedData(\n    $request: CreateSetDefaultProfileRequest!\n    $options: TypedDataOptions\n  ) {\n    result: createSetDefaultProfileTypedData(request: $request, options: $options) {\n      ...SetDefaultProfileTypedData\n    }\n  }\n  ", "\n"])), SetDefaultProfileTypedDataFragmentDoc);
var CreateSetProfileImageUriTypedDataDocument = gql__default["default"](_templateObject26$1 || (_templateObject26$1 = _taggedTemplateLiteral(["\n  mutation CreateSetProfileImageURITypedData(\n    $request: UpdateProfileImageRequest!\n    $options: TypedDataOptions\n  ) {\n    result: createSetProfileImageURITypedData(request: $request, options: $options) {\n      ...SetProfileImageURITypedData\n    }\n  }\n  ", "\n"])), SetProfileImageUriTypedDataFragmentDoc);
var CreateSetProfileImageUriViaDispatcherDocument = gql__default["default"](_templateObject27$1 || (_templateObject27$1 = _taggedTemplateLiteral(["\n  mutation CreateSetProfileImageURIViaDispatcher($request: UpdateProfileImageRequest!) {\n    result: createSetProfileImageURIViaDispatcher(request: $request) {\n      __typename\n      ... on RelayerResult {\n        ...RelayerResult\n      }\n      ... on RelayError {\n        ...RelayError\n      }\n    }\n  }\n  ", "\n  ", "\n"])), RelayerResultFragmentDoc, RelayErrorFragmentDoc);
var CreateSetProfileMetadataTypedDataDocument = gql__default["default"](_templateObject28$1 || (_templateObject28$1 = _taggedTemplateLiteral(["\n  mutation CreateSetProfileMetadataTypedData(\n    $request: CreatePublicSetProfileMetadataURIRequest!\n    $options: TypedDataOptions\n  ) {\n    result: createSetProfileMetadataTypedData(request: $request, options: $options) {\n      ...SetProfileMetadataTypedData\n    }\n  }\n  ", "\n"])), SetProfileMetadataTypedDataFragmentDoc);
var CreateSetProfileMetadataViaDispatcherDocument = gql__default["default"](_templateObject29$1 || (_templateObject29$1 = _taggedTemplateLiteral(["\n  mutation CreateSetProfileMetadataViaDispatcher(\n    $request: CreatePublicSetProfileMetadataURIRequest!\n  ) {\n    result: createSetProfileMetadataViaDispatcher(request: $request) {\n      __typename\n      ... on RelayerResult {\n        ...RelayerResult\n      }\n      ... on RelayError {\n        ...RelayError\n      }\n    }\n  }\n  ", "\n  ", "\n"])), RelayerResultFragmentDoc, RelayErrorFragmentDoc);
var CreateSetDispatcherTypedDataDocument = gql__default["default"](_templateObject30$1 || (_templateObject30$1 = _taggedTemplateLiteral(["\n  mutation CreateSetDispatcherTypedData(\n    $request: SetDispatcherRequest!\n    $options: TypedDataOptions\n  ) {\n    result: createSetDispatcherTypedData(request: $request, options: $options) {\n      ...SetDispatcherTypedData\n    }\n  }\n  ", "\n"])), SetDispatcherTypedDataFragmentDoc);
var CreateFollowTypedDataDocument = gql__default["default"](_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  mutation CreateFollowTypedData($request: FollowRequest!, $options: TypedDataOptions) {\n    result: createFollowTypedData(request: $request, options: $options) {\n      ...FollowTypedData\n    }\n  }\n  ", "\n"])), FollowTypedDataFragmentDoc);
var CreateUnfollowTypedDataDocument = gql__default["default"](_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n  mutation CreateUnfollowTypedData($request: UnfollowRequest!, $options: TypedDataOptions) {\n    result: createUnfollowTypedData(request: $request, options: $options) {\n      ...UnfollowTypedData\n    }\n  }\n  ", "\n"])), UnfollowTypedDataFragmentDoc);
var CreateSetFollowModuleTypedDataDocument = gql__default["default"](_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["\n  mutation CreateSetFollowModuleTypedData(\n    $request: CreateSetFollowModuleRequest!\n    $options: TypedDataOptions\n  ) {\n    result: createSetFollowModuleTypedData(request: $request, options: $options) {\n      ...SetFollowModuleTypedData\n    }\n  }\n  ", "\n"])), SetFollowModuleTypedDataFragmentDoc);
var CreateSetFollowNftUriTypedDataDocument = gql__default["default"](_templateObject34 || (_templateObject34 = _taggedTemplateLiteral(["\n  mutation CreateSetFollowNFTUriTypedData(\n    $request: CreateSetFollowNFTUriRequest!\n    $options: TypedDataOptions\n  ) {\n    result: createSetFollowNFTUriTypedData(request: $request, options: $options) {\n      ...SetFollowNFTUriTypedData\n    }\n  }\n  ", "\n"])), SetFollowNftUriTypedDataFragmentDoc);
var AddProfileInterestDocument = gql__default["default"](_templateObject35 || (_templateObject35 = _taggedTemplateLiteral(["\n  mutation AddProfileInterest($request: AddProfileInterestsRequest!) {\n    addProfileInterests(request: $request)\n  }\n"])));
var RemoveProfileInterestDocument = gql__default["default"](_templateObject36 || (_templateObject36 = _taggedTemplateLiteral(["\n  mutation RemoveProfileInterest($request: RemoveProfileInterestsRequest!) {\n    removeProfileInterests(request: $request)\n  }\n"])));
var DismissRecommendedProfilesDocument = gql__default["default"](_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["\n  mutation DismissRecommendedProfiles($request: DismissRecommendedProfilesRequest!) {\n    dismissRecommendedProfiles(request: $request)\n  }\n"])));
var ProfileGuardianDocument = gql__default["default"](_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["\n  query ProfileGuardian($request: ProfileGuardianRequest!) {\n    result: profileGuardianInformation(request: $request) {\n      ...ProfileGuardianResult\n    }\n  }\n  ", "\n"])), ProfileGuardianResultFragmentDoc);
var defaultWrapper$7 = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var ProfileDocumentString = graphql.print(ProfileDocument);
var ProfileStatsDocumentString = graphql.print(ProfileStatsDocument);
var ProfilesDocumentString = graphql.print(ProfilesDocument);
var RecommendedProfilesDocumentString = graphql.print(RecommendedProfilesDocument);
var MutualFollowersProfilesDocumentString = graphql.print(MutualFollowersProfilesDocument);
var DoesFollowDocumentString = graphql.print(DoesFollowDocument);
var FollowingDocumentString = graphql.print(FollowingDocument);
var FollowersDocumentString = graphql.print(FollowersDocument);
var FollowerNftOwnedTokenIdsDocumentString = graphql.print(FollowerNftOwnedTokenIdsDocument);
var PendingApprovalFollowsDocumentString = graphql.print(PendingApprovalFollowsDocument);
var ProfileInterestsDocumentString = graphql.print(ProfileInterestsDocument);
var CreateProfileDocumentString = graphql.print(CreateProfileDocument);
var CreateBurnProfileTypedDataDocumentString = graphql.print(CreateBurnProfileTypedDataDocument);
var CreateSetDefaultProfileTypedDataDocumentString = graphql.print(CreateSetDefaultProfileTypedDataDocument);
var CreateSetProfileImageUriTypedDataDocumentString = graphql.print(CreateSetProfileImageUriTypedDataDocument);
var CreateSetProfileImageUriViaDispatcherDocumentString = graphql.print(CreateSetProfileImageUriViaDispatcherDocument);
var CreateSetProfileMetadataTypedDataDocumentString = graphql.print(CreateSetProfileMetadataTypedDataDocument);
var CreateSetProfileMetadataViaDispatcherDocumentString = graphql.print(CreateSetProfileMetadataViaDispatcherDocument);
var CreateSetDispatcherTypedDataDocumentString = graphql.print(CreateSetDispatcherTypedDataDocument);
var CreateFollowTypedDataDocumentString = graphql.print(CreateFollowTypedDataDocument);
var CreateUnfollowTypedDataDocumentString = graphql.print(CreateUnfollowTypedDataDocument);
var CreateSetFollowModuleTypedDataDocumentString = graphql.print(CreateSetFollowModuleTypedDataDocument);
var CreateSetFollowNftUriTypedDataDocumentString = graphql.print(CreateSetFollowNftUriTypedDataDocument);
var AddProfileInterestDocumentString = graphql.print(AddProfileInterestDocument);
var RemoveProfileInterestDocumentString = graphql.print(RemoveProfileInterestDocument);
var DismissRecommendedProfilesDocumentString = graphql.print(DismissRecommendedProfilesDocument);
var ProfileGuardianDocumentString = graphql.print(ProfileGuardianDocument);
function getSdk$7(client) {
  ...
  return {
    ...
    ProfileGuardian: function ProfileGuardian(variables, requestHeaders) {
      return withWrapper(function (wrappedRequestHeaders) {
        return client.rawRequest(ProfileGuardianDocumentString, variables, _objectSpread2(_objectSpread2({}, requestHeaders), wrappedRequestHeaders));
      }, 'ProfileGuardian', 'query');
    }
  };
}
...
var Profile = /*#__PURE__*/function () {
  ...
  _createClass(Profile, [{
                ...
                var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(headers) {
                  ...
                  return _regeneratorRuntime().wrap(function _callee$(_context) {
                    while (1) switch (_context.prev = _context.next) {
                      case 0:
                        _context.next = 2;
                        return _this.sdk.Profile(_objectSpread2({
                          request: request,
                          observerId: observerId
                        }, buildMediaTransformsFromConfig(_this.config.mediaTransforms)), headers);
                      case 2:
                          ...
                          var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(currRequest) {
                            ...
                            return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                              while (1) switch (_context5.prev = _context5.next) {
                                case 0:
                                  _context5.next = 2;
                                  return _this3.sdk.Profiles(_objectSpread2({
                                    request: currRequest,
                                    observerId: observerId
                                  }, buildMediaTransformsFromConfig(_this3.config.mediaTransforms)), headers);
                                case 2:
                                  result = _context5.sent;
                                  return _context5.abrupt("return", result.data.result);
                                case 4:
                ...
                var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(headers) {
                  ...
                  return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                    while (1) switch (_context8.prev = _context8.next) {
                      case 0:
                        _context8.next = 2;
                        return _this4.sdk.RecommendedProfiles(_objectSpread2({
                          options: options,
                          observerId: observerId
                        }, buildMediaTransformsFromConfig(_this4.config.mediaTransforms)), headers);
                      case 2:
                        result = _context8.sent;
                        return _context8.abrupt("return", result.data.result);
                      case 4:
                          ...
                          var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(currRequest) {
                            ...
                            return _regeneratorRuntime().wrap(function _callee12$(_context12) {
                              while (1) switch (_context12.prev = _context12.next) {
                                case 0:
                                  _context12.next = 2;
                                  return _this6.sdk.MutualFollowersProfiles(_objectSpread2({
                                    request: currRequest,
                                    observerId: observerId
                                  }, buildMediaTransformsFromConfig(_this6.config.mediaTransforms)), headers);
                                case 2:
                          ...
                          var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee17(currRequest) {
                            ...
                            return _regeneratorRuntime().wrap(function _callee17$(_context17) {
                              while (1) switch (_context17.prev = _context17.next) {
                                case 0:
                                  _context17.next = 2;
                                  return _this8.sdk.Following(_objectSpread2({
                                    request: currRequest,
                                    observerId: observerId
                                  }, buildMediaTransformsFromConfig(_this8.config.mediaTransforms)), headers);
                                case 2:
                          ...
                          var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee20(currRequest) {
                            ...
                            return _regeneratorRuntime().wrap(function _callee20$(_context20) {
                              while (1) switch (_context20.prev = _context20.next) {
                                case 0:
                                  _context20.next = 2;
                                  return _this9.sdk.Followers(_objectSpread2({
                                    request: currRequest,
                                    observerId: observerId
                                  }, buildMediaTransformsFromConfig(_this9.config.mediaTransforms)), headers);
                                case 2:
                          ...
                          var _ref28 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee49(currRequest) {
                            ...
                            return _regeneratorRuntime().wrap(function _callee49$(_context49) {
                              while (1) switch (_context49.prev = _context49.next) {
                                case 0:
                                  _context49.next = 2;
                                  return _this23.sdk.PendingApprovalFollows(_objectSpread2({
                                    request: currRequest,
                                    observerId: observerId
                                  }, buildMediaTransformsFromConfig(_this23.config.mediaTransforms)), headers);
                                case 2:
    ...
    key: "guardian",
    value: function () {
      var _guardian = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee59(request) {
        var _this27 = this;
        return _regeneratorRuntime().wrap(function _callee59$(_context59) {
          while (1) switch (_context59.prev = _context59.next) {
            case 0:
              return _context59.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref32 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee58(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee58$(_context58) {
                    while (1) switch (_context58.prev = _context58.next) {
                      case 0:
                        _context58.next = 2;
                        return _this27.sdk.ProfileGuardian({
                          request: request
                        }, headers);
                      case 2:
                        result = _context58.sent;
                        return _context58.abrupt("return", result.data.result);
                      case 4:
                      case "end":
      ...
      function guardian(_x72) {
        return _guardian.apply(this, arguments);
      }
      return guardian;
    }()
  }]);
...
var ProxyActionStatusResultFragmentDoc = gql__default["default"](_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral(["\n  fragment ProxyActionStatusResult on ProxyActionStatusResult {\n    __typename\n    txHash\n    txId\n    status\n  }\n"])));
var ProxyActionErrorFragmentDoc = gql__default["default"](_templateObject2$6 || (_templateObject2$6 = _taggedTemplateLiteral(["\n  fragment ProxyActionError on ProxyActionError {\n    __typename\n    reason\n    lastKnownTxId\n  }\n"])));
var ProxyActionQueuedFragmentDoc = gql__default["default"](_templateObject3$4 || (_templateObject3$4 = _taggedTemplateLiteral(["\n  fragment ProxyActionQueued on ProxyActionQueued {\n    __typename\n    queuedAt\n  }\n"])));
var ProxyActionStatusDocument = gql__default["default"](_templateObject4$4 || (_templateObject4$4 = _taggedTemplateLiteral(["\n  query ProxyActionStatus($proxyActionId: ProxyActionId!) {\n    result: proxyActionStatus(proxyActionId: $proxyActionId) {\n      ... on ProxyActionStatusResult {\n        ...ProxyActionStatusResult\n      }\n      ... on ProxyActionError {\n        ...ProxyActionError\n      }\n      ... on ProxyActionQueued {\n        ...ProxyActionQueued\n      }\n    }\n  }\n  ", "\n  ", "\n  ", "\n"])), ProxyActionStatusResultFragmentDoc, ProxyActionErrorFragmentDoc, ProxyActionQueuedFragmentDoc);
var ProxyActionDocument = gql__default["default"](_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteral(["\n  mutation ProxyAction($request: ProxyActionRequest!) {\n    result: proxyAction(request: $request)\n  }\n"])));
var defaultWrapper$6 = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var ProxyActionStatusDocumentString = graphql.print(ProxyActionStatusDocument);
var ProxyActionDocumentString = graphql.print(ProxyActionDocument);
                ...
                validate: function validate(result) {
                  if (result.isSuccess()) {
                    ...
                    if (isProxyActionStatusResult(value)) {
                      return value.status === exports.ProxyActionStatusTypes.Complete;
                    }
                  }
...
var PublicationStatsFragmentDoc = gql__default["default"](_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral(["\n  fragment PublicationStats on PublicationStats {\n    __typename\n    totalAmountOfMirrors\n    totalAmountOfCollects\n    totalAmountOfComments\n    totalUpvotes\n    totalDownvotes\n    commentsTotal(forSources: $sources)\n  }\n"])));
var MediaOutputFragmentDoc = gql__default["default"](_templateObject2$5 || (_templateObject2$5 = _taggedTemplateLiteral(["\n  fragment MediaOutput on MediaOutput {\n    altTag\n    cover\n    item\n    source\n    type\n  }\n"])));
var PublicMediaResultsFragmentDoc = gql__default["default"](_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral(["\n  fragment PublicMediaResults on PublicMediaResults {\n    media {\n      ...MediaOutput\n    }\n    signedUrl\n  }\n  ", "\n"])), MediaOutputFragmentDoc);
var CreatePostTypedDataFragmentDoc = gql__default["default"](_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral(["\n  fragment CreatePostTypedData on CreatePostBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        PostWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        ...EIP712TypedDataDomain\n      }\n      value {\n        nonce\n        deadline\n        profileId\n        contentURI\n        collectModule\n        collectModuleInitData\n        referenceModule\n        referenceModuleInitData\n      }\n    }\n  }\n  ", "\n"])), Eip712TypedDataDomainFragmentDoc);
var CreateCommentTypedDataFragmentDoc = gql__default["default"](_templateObject5$2 || (_templateObject5$2 = _taggedTemplateLiteral(["\n  fragment CreateCommentTypedData on CreateCommentBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        CommentWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        ...EIP712TypedDataDomain\n      }\n      value {\n        nonce\n        deadline\n        profileId\n        contentURI\n        profileIdPointed\n        pubIdPointed\n        collectModule\n        collectModuleInitData\n        referenceModuleData\n        referenceModule\n        referenceModuleInitData\n      }\n    }\n  }\n  ", "\n"])), Eip712TypedDataDomainFragmentDoc);
var CreateMirrorTypedDataFragmentDoc = gql__default["default"](_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  fragment CreateMirrorTypedData on CreateMirrorBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        MirrorWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        ...EIP712TypedDataDomain\n      }\n      value {\n        nonce\n        deadline\n        profileId\n        profileIdPointed\n        pubIdPointed\n        referenceModuleData\n        referenceModule\n        referenceModuleInitData\n      }\n    }\n  }\n  ", "\n"])), Eip712TypedDataDomainFragmentDoc);
var CreateCollectTypedDataFragmentDoc = gql__default["default"](_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  fragment CreateCollectTypedData on CreateCollectBroadcastItemResult {\n    id\n    expiresAt\n    typedData {\n      types {\n        CollectWithSig {\n          name\n          type\n        }\n      }\n      domain {\n        ...EIP712TypedDataDomain\n      }\n      value {\n        nonce\n        deadline\n        profileId\n        pubId\n        data\n      }\n    }\n  }\n  ", "\n"])), Eip712TypedDataDomainFragmentDoc);
var PublicationDocument = gql__default["default"](_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  query Publication(\n    $request: PublicationQueryRequest!\n    $observerId: ProfileId\n    $mediaTransformPublication: MediaTransformParams = {}\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: publication(request: $request) {\n      ... on Post {\n        ...Post\n      }\n      ... on Mirror {\n        ...Mirror\n      }\n      ... on Comment {\n        ...Comment\n      }\n    }\n  }\n  ", "\n  ", "\n  ", "\n"])), PostFragmentDoc, MirrorFragmentDoc, CommentFragmentDoc);
var PublicationStatsDocument = gql__default["default"](_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  query PublicationStats($request: PublicationQueryRequest!, $sources: [Sources!]!) {\n    result: publication(request: $request) {\n      ... on Post {\n        stats {\n          ...PublicationStats\n        }\n      }\n      ... on Mirror {\n        stats {\n          ...PublicationStats\n        }\n      }\n      ... on Comment {\n        stats {\n          ...PublicationStats\n        }\n      }\n    }\n  }\n  ", "\n"])), PublicationStatsFragmentDoc);
var PublicationsDocument = gql__default["default"](_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  query Publications(\n    $request: PublicationsQueryRequest!\n    $observerId: ProfileId\n    $mediaTransformPublication: MediaTransformParams = {}\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: publications(request: $request) {\n      items {\n        ... on Post {\n          ...Post\n        }\n        ... on Mirror {\n          ...Mirror\n        }\n        ... on Comment {\n          ...Comment\n        }\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n  ", "\n  ", "\n"])), PostFragmentDoc, MirrorFragmentDoc, CommentFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var ValidatePublicationMetadataDocument = gql__default["default"](_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  query ValidatePublicationMetadata($metadata: PublicationMetadataV2Input!) {\n    validatePublicationMetadata(request: { metadatav2: $metadata }) {\n      __typename\n      valid\n      reason\n    }\n  }\n"])));
var WhoCollectedPublicationDocument = gql__default["default"](_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  query WhoCollectedPublication(\n    $request: WhoCollectedPublicationRequest!\n    $observerId: ProfileId\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: whoCollectedPublication(request: $request) {\n      items {\n        ...Wallet\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n"])), WalletFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var ProfilePublicationsForSaleDocument = gql__default["default"](_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  query ProfilePublicationsForSale(\n    $request: ProfilePublicationsForSaleRequest!\n    $observerId: ProfileId\n    $mediaTransformPublication: MediaTransformParams = {}\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: profilePublicationsForSale(request: $request) {\n      items {\n        ... on Post {\n          ...Post\n        }\n        ... on Comment {\n          ...Comment\n        }\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n  ", "\n"])), PostFragmentDoc, CommentFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var PublicationMetadataStatusDocument = gql__default["default"](_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  query PublicationMetadataStatus($request: GetPublicationMetadataStatusRequest!) {\n    result: publicationMetadataStatus(request: $request) {\n      __typename\n      reason\n      status\n    }\n  }\n"])));
var CreatePostTypedDataDocument = gql__default["default"](_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  mutation CreatePostTypedData($request: CreatePublicPostRequest!, $options: TypedDataOptions) {\n    result: createPostTypedData(request: $request, options: $options) {\n      ...CreatePostTypedData\n    }\n  }\n  ", "\n"])), CreatePostTypedDataFragmentDoc);
var CreatePostViaDispatcherDocument = gql__default["default"](_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  mutation CreatePostViaDispatcher($request: CreatePublicPostRequest!) {\n    result: createPostViaDispatcher(request: $request) {\n      ... on RelayerResult {\n        ...RelayerResult\n      }\n      ... on RelayError {\n        ...RelayError\n      }\n    }\n  }\n  ", "\n  ", "\n"])), RelayerResultFragmentDoc, RelayErrorFragmentDoc);
var CreateCommentTypedDataDocument = gql__default["default"](_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  mutation CreateCommentTypedData(\n    $request: CreatePublicCommentRequest!\n    $options: TypedDataOptions\n  ) {\n    result: createCommentTypedData(request: $request, options: $options) {\n      ...CreateCommentTypedData\n    }\n  }\n  ", "\n"])), CreateCommentTypedDataFragmentDoc);
var CreateCommentViaDispatcherDocument = gql__default["default"](_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  mutation CreateCommentViaDispatcher($request: CreatePublicCommentRequest!) {\n    result: createCommentViaDispatcher(request: $request) {\n      ... on RelayerResult {\n        ...RelayerResult\n      }\n      ... on RelayError {\n        ...RelayError\n      }\n    }\n  }\n  ", "\n  ", "\n"])), RelayerResultFragmentDoc, RelayErrorFragmentDoc);
var CreateMirrorTypedDataDocument = gql__default["default"](_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  mutation CreateMirrorTypedData($request: CreateMirrorRequest!, $options: TypedDataOptions) {\n    result: createMirrorTypedData(request: $request, options: $options) {\n      ...CreateMirrorTypedData\n    }\n  }\n  ", "\n"])), CreateMirrorTypedDataFragmentDoc);
var CreateMirrorViaDispatcherDocument = gql__default["default"](_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  mutation CreateMirrorViaDispatcher($request: CreateMirrorRequest!) {\n    result: createMirrorViaDispatcher(request: $request) {\n      ... on RelayerResult {\n        ...RelayerResult\n      }\n      ... on RelayError {\n        ...RelayError\n      }\n    }\n  }\n  ", "\n  ", "\n"])), RelayerResultFragmentDoc, RelayErrorFragmentDoc);
var CreateCollectTypedDataDocument = gql__default["default"](_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  mutation CreateCollectTypedData($request: CreateCollectRequest!, $options: TypedDataOptions) {\n    result: createCollectTypedData(request: $request, options: $options) {\n      ...CreateCollectTypedData\n    }\n  }\n  ", "\n"])), CreateCollectTypedDataFragmentDoc);
var CreateAttachMediaDataDocument = gql__default["default"](_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  mutation CreateAttachMediaData($request: PublicMediaRequest!) {\n    result: createAttachMediaData(request: $request) {\n      ...PublicMediaResults\n    }\n  }\n  ", "\n"])), PublicMediaResultsFragmentDoc);
var HidePublicationDocument = gql__default["default"](_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  mutation HidePublication($request: HidePublicationRequest!) {\n    hidePublication(request: $request)\n  }\n"])));
var ReportPublicationDocument = gql__default["default"](_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  mutation ReportPublication($request: ReportPublicationRequest!) {\n    reportPublication(request: $request)\n  }\n"])));
var CreateDataAvailabilityPostTypedDataDocument = gql__default["default"](_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  mutation CreateDataAvailabilityPostTypedData($request: CreateDataAvailabilityPostRequest!) {\n    result: createDataAvailabilityPostTypedData(request: $request) {\n      ...CreatePostTypedData\n    }\n  }\n  ", "\n"])), CreatePostTypedDataFragmentDoc);
var CreateDataAvailabilityPostViaDispatcherDocument = gql__default["default"](_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  mutation CreateDataAvailabilityPostViaDispatcher($request: CreateDataAvailabilityPostRequest!) {\n    result: createDataAvailabilityPostViaDispatcher(request: $request) {\n      ... on CreateDataAvailabilityPublicationResult {\n        ...CreateDataAvailabilityPublicationResult\n      }\n      ... on RelayError {\n        ...RelayError\n      }\n    }\n  }\n  ", "\n  ", "\n"])), CreateDataAvailabilityPublicationResultFragmentDoc, RelayErrorFragmentDoc);
var CreateDataAvailabilityCommentTypedDataDocument = gql__default["default"](_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  mutation CreateDataAvailabilityCommentTypedData($request: CreateDataAvailabilityCommentRequest!) {\n    result: createDataAvailabilityCommentTypedData(request: $request) {\n      ...CreateCommentTypedData\n    }\n  }\n  ", "\n"])), CreateCommentTypedDataFragmentDoc);
var CreateDataAvailabilityCommentViaDispatcherDocument = gql__default["default"](_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  mutation CreateDataAvailabilityCommentViaDispatcher(\n    $request: CreateDataAvailabilityCommentRequest!\n  ) {\n    result: createDataAvailabilityCommentViaDispatcher(request: $request) {\n      ... on CreateDataAvailabilityPublicationResult {\n        ...CreateDataAvailabilityPublicationResult\n      }\n      ... on RelayError {\n        ...RelayError\n      }\n    }\n  }\n  ", "\n  ", "\n"])), CreateDataAvailabilityPublicationResultFragmentDoc, RelayErrorFragmentDoc);
var CreateDataAvailabilityMirrorTypedDataDocument = gql__default["default"](_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  mutation CreateDataAvailabilityMirrorTypedData($request: CreateDataAvailabilityMirrorRequest!) {\n    result: createDataAvailabilityMirrorTypedData(request: $request) {\n      ...CreateMirrorTypedData\n    }\n  }\n  ", "\n"])), CreateMirrorTypedDataFragmentDoc);
var CreateDataAvailabilityMirrorViaDispatcherDocument = gql__default["default"](_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  mutation CreateDataAvailabilityMirrorViaDispatcher(\n    $request: CreateDataAvailabilityMirrorRequest!\n  ) {\n    result: createDataAvailabilityMirrorViaDispatcher(request: $request) {\n      ... on CreateDataAvailabilityPublicationResult {\n        ...CreateDataAvailabilityPublicationResult\n      }\n      ... on RelayError {\n        ...RelayError\n      }\n    }\n  }\n  ", "\n  ", "\n"])), CreateDataAvailabilityPublicationResultFragmentDoc, RelayErrorFragmentDoc);
var defaultWrapper$5 = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var PublicationDocumentString = graphql.print(PublicationDocument);
var PublicationStatsDocumentString = graphql.print(PublicationStatsDocument);
var PublicationsDocumentString = graphql.print(PublicationsDocument);
var ValidatePublicationMetadataDocumentString = graphql.print(ValidatePublicationMetadataDocument);
var WhoCollectedPublicationDocumentString = graphql.print(WhoCollectedPublicationDocument);
var ProfilePublicationsForSaleDocumentString = graphql.print(ProfilePublicationsForSaleDocument);
var PublicationMetadataStatusDocumentString = graphql.print(PublicationMetadataStatusDocument);
var CreatePostTypedDataDocumentString = graphql.print(CreatePostTypedDataDocument);
var CreatePostViaDispatcherDocumentString = graphql.print(CreatePostViaDispatcherDocument);
var CreateCommentTypedDataDocumentString = graphql.print(CreateCommentTypedDataDocument);
var CreateCommentViaDispatcherDocumentString = graphql.print(CreateCommentViaDispatcherDocument);
var CreateMirrorTypedDataDocumentString = graphql.print(CreateMirrorTypedDataDocument);
var CreateMirrorViaDispatcherDocumentString = graphql.print(CreateMirrorViaDispatcherDocument);
var CreateCollectTypedDataDocumentString = graphql.print(CreateCollectTypedDataDocument);
var CreateAttachMediaDataDocumentString = graphql.print(CreateAttachMediaDataDocument);
var HidePublicationDocumentString = graphql.print(HidePublicationDocument);
var ReportPublicationDocumentString = graphql.print(ReportPublicationDocument);
var CreateDataAvailabilityPostTypedDataDocumentString = graphql.print(CreateDataAvailabilityPostTypedDataDocument);
var CreateDataAvailabilityPostViaDispatcherDocumentString = graphql.print(CreateDataAvailabilityPostViaDispatcherDocument);
var CreateDataAvailabilityCommentTypedDataDocumentString = graphql.print(CreateDataAvailabilityCommentTypedDataDocument);
var CreateDataAvailabilityCommentViaDispatcherDocumentString = graphql.print(CreateDataAvailabilityCommentViaDispatcherDocument);
var CreateDataAvailabilityMirrorTypedDataDocumentString = graphql.print(CreateDataAvailabilityMirrorTypedDataDocument);
var CreateDataAvailabilityMirrorViaDispatcherDocumentString = graphql.print(CreateDataAvailabilityMirrorViaDispatcherDocument);
...
var Publication = /*#__PURE__*/function () {
  ...
  _createClass(Publication, [{
                ...
                var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(headers) {
                  ...
                  return _regeneratorRuntime().wrap(function _callee$(_context) {
                    while (1) switch (_context.prev = _context.next) {
                      case 0:
                        _context.next = 2;
                        return _this.sdk.Publication(_objectSpread2({
                          request: request,
                          observerId: observerId
                        }, buildMediaTransformsFromConfig(_this.config.mediaTransforms)), headers);
                      case 2:
                          ...
                          var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(currRequest) {
                            ...
                            return _regeneratorRuntime().wrap(function _callee9$(_context9) {
                              while (1) switch (_context9.prev = _context9.next) {
                                case 0:
                                  _context9.next = 2;
                                  return _this5.sdk.Publications(_objectSpread2({
                                    request: currRequest,
                                    observerId: observerId
                                  }, buildMediaTransformsFromConfig(_this5.config.mediaTransforms)), headers);
                                case 2:
    ...
    value: function () {
      var _allWalletsWhoCollected = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(request, observerId) {
        var _this6 = this;
        return _regeneratorRuntime().wrap(function _callee14$(_context14) {
          while (1) switch (_context14.prev = _context14.next) {
            case 0:
                          ...
                          var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(currRequest) {
                            ...
                            return _regeneratorRuntime().wrap(function _callee12$(_context12) {
                              while (1) switch (_context12.prev = _context12.next) {
                                case 0:
                                  _context12.next = 2;
                                  return _this6.sdk.WhoCollectedPublication(_objectSpread2({
                                    request: currRequest,
                                    observerId: observerId
                                  }, buildMediaTransformsFromConfig(_this6.config.mediaTransforms)), headers);
                                case 2:
      ...
      function allWalletsWhoCollected(_x15, _x16) {
    ...
    key: "allForSale",
    value: function () {
      var _allForSale = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee17(request, observerId) {
        var _this7 = this;
        return _regeneratorRuntime().wrap(function _callee17$(_context17) {
          while (1) switch (_context17.prev = _context17.next) {
            case 0:
                          ...
                          var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15(currRequest) {
                            ...
                            return _regeneratorRuntime().wrap(function _callee15$(_context15) {
                              while (1) switch (_context15.prev = _context15.next) {
                                case 0:
                                  _context15.next = 2;
                                  return _this7.sdk.ProfilePublicationsForSale(_objectSpread2({
                                    request: currRequest,
                                    observerId: observerId
                                  }, buildMediaTransformsFromConfig(_this7.config.mediaTransforms)), headers);
                                case 2:
                                  result = _context15.sent;
                                  return _context15.abrupt("return", result.data.result);
                                case 4:
    ...
    value: function () {
      var _createPostTypedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee19(request, options) {
        var _this8 = this;
        return _regeneratorRuntime().wrap(function _callee19$(_context19) {
          while (1) switch (_context19.prev = _context19.next) {
            case 0:
              return _context19.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee18(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee18$(_context18) {
                    while (1) switch (_context18.prev = _context18.next) {
                      case 0:
                        _context18.next = 2;
                        return _this8.sdk.CreatePostTypedData({
                          request: request,
                          options: options
                        }, headers);
                      case 2:
      ...
      function createPostTypedData(_x23, _x24) {
    ...
    value: function () {
      var _createPostViaDispatcher = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee21(request) {
        var _this9 = this;
        return _regeneratorRuntime().wrap(function _callee21$(_context21) {
          while (1) switch (_context21.prev = _context21.next) {
            case 0:
              return _context21.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee20(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee20$(_context20) {
                    while (1) switch (_context20.prev = _context20.next) {
                      case 0:
                        _context20.next = 2;
                        return _this9.sdk.CreatePostViaDispatcher({
                          request: request
                        }, headers);
                      case 2:
                        result = _context20.sent;
      ...
      function createPostViaDispatcher(_x26) {
    ...
    value: function () {
      var _createCommentTypedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee23(request, options) {
        var _this10 = this;
        return _regeneratorRuntime().wrap(function _callee23$(_context23) {
          while (1) switch (_context23.prev = _context23.next) {
            case 0:
              return _context23.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee22(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee22$(_context22) {
                    while (1) switch (_context22.prev = _context22.next) {
                      case 0:
                        _context22.next = 2;
                        return _this10.sdk.CreateCommentTypedData({
                          request: request,
                          options: options
                        }, headers);
                      case 2:
      ...
      function createCommentTypedData(_x28, _x29) {
    ...
    value: function () {
      var _createCommentViaDispatcher = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee25(request) {
        var _this11 = this;
        return _regeneratorRuntime().wrap(function _callee25$(_context25) {
          while (1) switch (_context25.prev = _context25.next) {
            case 0:
              return _context25.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee24(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee24$(_context24) {
                    while (1) switch (_context24.prev = _context24.next) {
                      case 0:
                        _context24.next = 2;
                        return _this11.sdk.CreateCommentViaDispatcher({
                          request: request
                        }, headers);
                      case 2:
      ...
      function createCommentViaDispatcher(_x31) {
    ...
    value: function () {
      var _createMirrorTypedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee27(request, options) {
        var _this12 = this;
        return _regeneratorRuntime().wrap(function _callee27$(_context27) {
          while (1) switch (_context27.prev = _context27.next) {
            case 0:
              return _context27.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref15 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee26(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee26$(_context26) {
                    while (1) switch (_context26.prev = _context26.next) {
                      case 0:
                        _context26.next = 2;
                        return _this12.sdk.CreateMirrorTypedData({
                          request: request,
                          options: options
                        }, headers);
                      case 2:
      ...
      function createMirrorTypedData(_x33, _x34) {
    ...
    value: function () {
      var _createMirrorViaDispatcher = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee29(request) {
        var _this13 = this;
        return _regeneratorRuntime().wrap(function _callee29$(_context29) {
          while (1) switch (_context29.prev = _context29.next) {
            case 0:
              return _context29.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref16 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee28(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee28$(_context28) {
                    while (1) switch (_context28.prev = _context28.next) {
                      case 0:
                        _context28.next = 2;
                        return _this13.sdk.CreateMirrorViaDispatcher({
                          request: request
                        }, headers);
                      case 2:
      ...
      function createMirrorViaDispatcher(_x36) {
    ...
    value: function () {
      var _createCollectTypedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee31(request, options) {
        var _this14 = this;
        return _regeneratorRuntime().wrap(function _callee31$(_context31) {
          while (1) switch (_context31.prev = _context31.next) {
            case 0:
              return _context31.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref17 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee30(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee30$(_context30) {
                    while (1) switch (_context30.prev = _context30.next) {
                      case 0:
                        _context30.next = 2;
                        return _this14.sdk.CreateCollectTypedData({
                          request: request,
                          options: options
                        }, headers);
                      case 2:
      ...
      function createCollectTypedData(_x38, _x39) {
    ...
    value: function () {
      var _createAttachMediaData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee33(request) {
        var _this15 = this;
        return _regeneratorRuntime().wrap(function _callee33$(_context33) {
          while (1) switch (_context33.prev = _context33.next) {
            case 0:
              return _context33.abrupt("return", provideAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref18 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee32(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee32$(_context32) {
                    while (1) switch (_context32.prev = _context32.next) {
                      case 0:
                        _context32.next = 2;
                        return _this15.sdk.CreateAttachMediaData({
                          request: request
                        }, headers);
                      case 2:
      ...
      function createAttachMediaData(_x41) {
    ...
    key: "hide",
    value: function () {
      var _hide = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee35(request) {
        var _this16 = this;
        return _regeneratorRuntime().wrap(function _callee35$(_context35) {
          while (1) switch (_context35.prev = _context35.next) {
            case 0:
              return _context35.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref19 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee34(headers) {
                  return _regeneratorRuntime().wrap(function _callee34$(_context34) {
                    while (1) switch (_context34.prev = _context34.next) {
                      case 0:
                        _context34.next = 2;
                        return _this16.sdk.HidePublication({
                          request: request
                        }, headers);
                      case 2:
                      case "end":
    ...
    key: "report",
    value: function () {
      var _report = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee37(request) {
        var _this17 = this;
        return _regeneratorRuntime().wrap(function _callee37$(_context37) {
          while (1) switch (_context37.prev = _context37.next) {
            case 0:
              return _context37.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref20 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee36(headers) {
                  return _regeneratorRuntime().wrap(function _callee36$(_context36) {
                    while (1) switch (_context36.prev = _context36.next) {
                      case 0:
                        _context36.next = 2;
                        return _this17.sdk.ReportPublication({
                          request: request
                        }, headers);
                      case 2:
                      case "end":
    ...
    value: function () {
      var _createDataAvailabilityPostTypedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee39(request) {
        var _this18 = this;
        return _regeneratorRuntime().wrap(function _callee39$(_context39) {
          while (1) switch (_context39.prev = _context39.next) {
            case 0:
              return _context39.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref21 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee38(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee38$(_context38) {
                    while (1) switch (_context38.prev = _context38.next) {
                      case 0:
                        _context38.next = 2;
                        return _this18.sdk.CreateDataAvailabilityPostTypedData({
                          request: request
                        }, headers);
                      case 2:
      ...
      function createDataAvailabilityPostTypedData(_x47) {
    ...
    value: function () {
      var _createDataAvailabilityPostViaDispatcher = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee41(request) {
        var _this19 = this;
        return _regeneratorRuntime().wrap(function _callee41$(_context41) {
          while (1) switch (_context41.prev = _context41.next) {
            case 0:
              return _context41.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref22 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee40(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee40$(_context40) {
                    while (1) switch (_context40.prev = _context40.next) {
                      case 0:
                        _context40.next = 2;
                        return _this19.sdk.CreateDataAvailabilityPostViaDispatcher({
                          request: request
                        }, headers);
                      case 2:
      ...
      function createDataAvailabilityPostViaDispatcher(_x49) {
    ...
    value: function () {
      var _createDataAvailabilityCommentTypedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee43(request) {
        var _this20 = this;
        return _regeneratorRuntime().wrap(function _callee43$(_context43) {
          while (1) switch (_context43.prev = _context43.next) {
            case 0:
              return _context43.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref23 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee42(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee42$(_context42) {
                    while (1) switch (_context42.prev = _context42.next) {
                      case 0:
                        _context42.next = 2;
                        return _this20.sdk.CreateDataAvailabilityCommentTypedData({
                          request: request
                        }, headers);
                      case 2:
      ...
      function createDataAvailabilityCommentTypedData(_x51) {
    ...
    value: function () {
      var _createDataAvailabilityCommentViaDispatcher = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee45(request) {
        var _this21 = this;
        return _regeneratorRuntime().wrap(function _callee45$(_context45) {
          while (1) switch (_context45.prev = _context45.next) {
            case 0:
              return _context45.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref24 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee44(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee44$(_context44) {
                    while (1) switch (_context44.prev = _context44.next) {
                      case 0:
                        _context44.next = 2;
                        return _this21.sdk.CreateDataAvailabilityCommentViaDispatcher({
                          request: request
                        }, headers);
                      case 2:
      ...
      function createDataAvailabilityCommentViaDispatcher(_x53) {
    ...
    value: function () {
      var _createDataAvailabilityMirrorTypedData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee47(request) {
        var _this22 = this;
        return _regeneratorRuntime().wrap(function _callee47$(_context47) {
          while (1) switch (_context47.prev = _context47.next) {
            case 0:
              return _context47.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref25 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee46(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee46$(_context46) {
                    while (1) switch (_context46.prev = _context46.next) {
                      case 0:
                        _context46.next = 2;
                        return _this22.sdk.CreateDataAvailabilityMirrorTypedData({
                          request: request
                        }, headers);
                      case 2:
      ...
      function createDataAvailabilityMirrorTypedData(_x55) {
    ...
    value: function () {
      var _createDataAvailabilityMirrorViaDispatcher = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee49(request) {
        var _this23 = this;
        return _regeneratorRuntime().wrap(function _callee49$(_context49) {
          while (1) switch (_context49.prev = _context49.next) {
            case 0:
              return _context49.abrupt("return", requireAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref26 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee48(headers) {
                  var result;
                  return _regeneratorRuntime().wrap(function _callee48$(_context48) {
                    while (1) switch (_context48.prev = _context48.next) {
                      case 0:
                        _context48.next = 2;
                        return _this23.sdk.CreateDataAvailabilityMirrorViaDispatcher({
                          request: request
                        }, headers);
                      case 2:
                        result = _context48.sent;
                        return _context48.abrupt("return", result.data.result);
                      case 4:
                      case "end":
                        return _context48.stop();
                    }
      ...
      function createDataAvailabilityMirrorViaDispatcher(_x57) {
...
exports.PublicationReportReason = void 0;
...
})(exports.PublicationReportReason || (exports.PublicationReportReason = {}));
var buildReportingReasonInputParams = function buildReportingReasonInputParams(reason) {
  switch (reason) {
    case exports.PublicationReportReason.VIOLENCE:
      return {
        illegalReason: {
          reason: exports.PublicationReportingReason.Illegal,
          subreason: exports.PublicationReportingIllegalSubreason.Violence
        }
      };
    case exports.PublicationReportReason.SELF_HARM:
      return {
        illegalReason: {
          reason: exports.PublicationReportingReason.Illegal,
          subreason: exports.PublicationReportingIllegalSubreason.ThreatIndividual
        }
      };
    case exports.PublicationReportReason.DIRECT_THREAT:
      return {
        illegalReason: {
          reason: exports.PublicationReportingReason.Illegal,
          subreason: exports.PublicationReportingIllegalSubreason.DirectThreat
        }
      };
    case exports.PublicationReportReason.HARASSMENT:
    case exports.PublicationReportReason.HATE_SPEECH:
      return {
        illegalReason: {
          reason: exports.PublicationReportingReason.Illegal,
          subreason: exports.PublicationReportingIllegalSubreason.HumanAbuse
        }
      };
    case exports.PublicationReportReason.ANIMAL_ABUSE:
      return {
        illegalReason: {
          reason: exports.PublicationReportingReason.Illegal,
          subreason: exports.PublicationReportingIllegalSubreason.AnimalAbuse
        }
      };
    case exports.PublicationReportReason.SCAM:
    case exports.PublicationReportReason.UNAUTHORIZED_SALE:
      return {
        fraudReason: {
          reason: exports.PublicationReportingReason.Fraud,
          subreason: exports.PublicationReportingFraudSubreason.Scam
        }
      };
    case exports.PublicationReportReason.IMPERSONATION:
      return {
        fraudReason: {
          reason: exports.PublicationReportingReason.Fraud,
          subreason: exports.PublicationReportingFraudSubreason.Impersonation
        }
      };
    case exports.PublicationReportReason.NUDITY:
      return {
        sensitiveReason: {
          reason: exports.PublicationReportingReason.Sensitive,
          subreason: exports.PublicationReportingSensitiveSubreason.Nsfw
        }
      };
    case exports.PublicationReportReason.OFFENSIVE:
      return {
        sensitiveReason: {
          reason: exports.PublicationReportingReason.Sensitive,
          subreason: exports.PublicationReportingSensitiveSubreason.Offensive
        }
      };
    case exports.PublicationReportReason.MISLEADING:
      return {
        spamReason: {
          reason: exports.PublicationReportingReason.Spam,
          subreason: exports.PublicationReportingSpamSubreason.Misleading
        }
      };
    case exports.PublicationReportReason.MISUSE_HASHTAGS:
      return {
        spamReason: {
          reason: exports.PublicationReportingReason.Spam,
          subreason: exports.PublicationReportingSpamSubreason.MisuseHashtags
        }
      };
    case exports.PublicationReportReason.UNRELATED:
      return {
        spamReason: {
          reason: exports.PublicationReportingReason.Spam,
          subreason: exports.PublicationReportingSpamSubreason.Unrelated
        }
      };
    case exports.PublicationReportReason.REPETITIVE:
      return {
        spamReason: {
          reason: exports.PublicationReportingReason.Spam,
          subreason: exports.PublicationReportingSpamSubreason.Repetitive
        }
      };
    case exports.PublicationReportReason.FAKE_ENGAGEMENT:
      return {
        spamReason: {
          reason: exports.PublicationReportingReason.Spam,
          subreason: exports.PublicationReportingSpamSubreason.FakeEngagement
        }
      };
    case exports.PublicationReportReason.MANIPULATION_ALGO:
      return {
        spamReason: {
          reason: exports.PublicationReportingReason.Spam,
          subreason: exports.PublicationReportingSpamSubreason.ManipulationAlgo
        }
      };
    case exports.PublicationReportReason.SOMETHING_ELSE:
      return {
        spamReason: {
          reason: exports.PublicationReportingReason.Spam,
          subreason: exports.PublicationReportingSpamSubreason.SomethingElse
        }
      };
    default:
...
var WhoReactedResultFragmentDoc = gql__default["default"](_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral(["\n  fragment WhoReactedResult on WhoReactedResult {\n    __typename\n    reactionId\n    reaction\n    reactionAt\n    profile {\n      ...Profile\n    }\n  }\n  ", "\n"])), ProfileFragmentDoc);
var AddReactionDocument = gql__default["default"](_templateObject2$4 || (_templateObject2$4 = _taggedTemplateLiteral(["\n  mutation AddReaction($request: ReactionRequest!) {\n    addReaction(request: $request)\n  }\n"])));
var RemoveReactionDocument = gql__default["default"](_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral(["\n  mutation RemoveReaction($request: ReactionRequest!) {\n    removeReaction(request: $request)\n  }\n"])));
var WhoReactedPublicationDocument = gql__default["default"](_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteral(["\n  query WhoReactedPublication(\n    $request: WhoReactedPublicationRequest!\n    $observerId: ProfileId\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: whoReactedPublication(request: $request) {\n      items {\n        ...WhoReactedResult\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n"])), WhoReactedResultFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var defaultWrapper$4 = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var AddReactionDocumentString = graphql.print(AddReactionDocument);
var RemoveReactionDocumentString = graphql.print(RemoveReactionDocument);
var WhoReactedPublicationDocumentString = graphql.print(WhoReactedPublicationDocument);
...
var RevenueAggregateFragmentDoc = gql__default["default"](_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n  fragment RevenueAggregate on RevenueAggregate {\n    __typename\n    total {\n      ...Erc20Amount\n    }\n  }\n  ", "\n"])), Erc20AmountFragmentDoc);
var PublicationRevenueFragmentDoc = gql__default["default"](_templateObject2$3 || (_templateObject2$3 = _taggedTemplateLiteral(["\n  fragment PublicationRevenue on PublicationRevenue {\n    __typename\n    publication {\n      ... on Post {\n        ...Post\n      }\n      ... on Mirror {\n        ...Mirror\n      }\n      ... on Comment {\n        ...Comment\n      }\n    }\n    revenue {\n      ...RevenueAggregate\n    }\n  }\n  ", "\n  ", "\n  ", "\n  ", "\n"])), PostFragmentDoc, MirrorFragmentDoc, CommentFragmentDoc, RevenueAggregateFragmentDoc);
var ProfilePublicationRevenueDocument = gql__default["default"](_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["\n  query ProfilePublicationRevenue(\n    $request: ProfilePublicationRevenueQueryRequest!\n    $observerId: ProfileId\n    $mediaTransformPublication: MediaTransformParams = {}\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: profilePublicationRevenue(request: $request) {\n      items {\n        ...PublicationRevenue\n      }\n      pageInfo {\n        ...CommonPaginatedResultInfo\n      }\n    }\n  }\n  ", "\n  ", "\n"])), PublicationRevenueFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var PublicationRevenueDocument = gql__default["default"](_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral(["\n  query PublicationRevenue(\n    $request: PublicationRevenueQueryRequest!\n    $observerId: ProfileId\n    $mediaTransformPublication: MediaTransformParams = {}\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: publicationRevenue(request: $request) {\n      ...PublicationRevenue\n    }\n  }\n  ", "\n"])), PublicationRevenueFragmentDoc);
var ProfileFollowRevenueDocument = gql__default["default"](_templateObject5$1 || (_templateObject5$1 = _taggedTemplateLiteral(["\n  query ProfileFollowRevenue($request: ProfileFollowRevenueQueryRequest!) {\n    result: profileFollowRevenue(request: $request) {\n      revenues {\n        ...RevenueAggregate\n      }\n    }\n  }\n  ", "\n"])), RevenueAggregateFragmentDoc);
var defaultWrapper$3 = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var ProfilePublicationRevenueDocumentString = graphql.print(ProfilePublicationRevenueDocument);
var PublicationRevenueDocumentString = graphql.print(PublicationRevenueDocument);
var ProfileFollowRevenueDocumentString = graphql.print(ProfileFollowRevenueDocument);
                          ...
                          var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(currRequest) {
                            ...
                            return _regeneratorRuntime().wrap(function _callee$(_context) {
                              while (1) switch (_context.prev = _context.next) {
                                case 0:
                                  _context.next = 2;
                                  return _this.sdk.ProfilePublicationRevenue(_objectSpread2({
                                    request: currRequest,
                                    observerId: observerId
                                  }, buildMediaTransformsFromConfig(_this.config.mediaTransforms)), headers);
                                case 2:
                ...
                var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(headers) {
                  ...
                  return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                    while (1) switch (_context6.prev = _context6.next) {
                      case 0:
                        _context6.next = 2;
                        return _this3.sdk.PublicationRevenue(_objectSpread2({
                          request: request,
                          observerId: observerId
                        }, buildMediaTransformsFromConfig(_this3.config.mediaTransforms)), headers);
                      case 2:
...
var SearchPublicationsDocument = gql__default["default"](_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n  query SearchPublications(\n    $limit: LimitScalar\n    $cursor: Cursor\n    $query: Search!\n    $sources: [Sources!]\n    $observerId: ProfileId\n    $mediaTransformPublication: MediaTransformParams = {}\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: search(\n      request: {\n        query: $query\n        type: PUBLICATION\n        limit: $limit\n        cursor: $cursor\n        sources: $sources\n      }\n    ) {\n      ... on PublicationSearchResult {\n        __typename\n        items {\n          ... on Post {\n            ...Post\n          }\n          ... on Comment {\n            ...Comment\n          }\n        }\n        pageInfo {\n          ...CommonPaginatedResultInfo\n        }\n      }\n      ... on ProfileSearchResult {\n        __typename\n      }\n    }\n  }\n  ", "\n  ", "\n  ", "\n"])), PostFragmentDoc, CommentFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var SearchProfilesDocument = gql__default["default"](_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral(["\n  query SearchProfiles(\n    $limit: LimitScalar!\n    $cursor: Cursor\n    $query: Search!\n    $observerId: ProfileId\n    $mediaTransformProfilePicture: MediaTransformParams = {}\n    $mediaTransformProfileCover: MediaTransformParams = {}\n  ) {\n    result: search(request: { query: $query, type: PROFILE, limit: $limit, cursor: $cursor }) {\n      ... on ProfileSearchResult {\n        __typename\n        items {\n          ...Profile\n        }\n        pageInfo {\n          ...CommonPaginatedResultInfo\n        }\n      }\n      ... on PublicationSearchResult {\n        __typename\n      }\n    }\n  }\n  ", "\n  ", "\n"])), ProfileFragmentDoc, CommonPaginatedResultInfoFragmentDoc);
var defaultWrapper$2 = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var SearchPublicationsDocumentString = graphql.print(SearchPublicationsDocument);
var SearchProfilesDocumentString = graphql.print(SearchProfilesDocument);
    ...
    value: function () {
      var _profiles = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(request) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              actualRequest = _objectSpread2(_objectSpread2({}, request), buildMediaTransformsFromConfig(this.config.mediaTransforms));
              return _context3.abrupt("return", provideAuthHeaders(this.authentication, /*#__PURE__*/function () {
                var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(headers) {
                  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                    while (1) switch (_context2.prev = _context2.next) {
                            ...
                            return _regeneratorRuntime().wrap(function _callee$(_context) {
                              while (1) switch (_context.prev = _context.next) {
                                ...
                                case 2:
                                  ...
                                  sharedKernel.invariant(result.__typename !== 'PublicationSearchResult', 'PublicationSearchResult is not expected in this query');
                            ...
                            return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                              while (1) switch (_context4.prev = _context4.next) {
                                ...
                                case 2:
                                  ...
                                  result = response.data.result;
                                  sharedKernel.invariant(result.__typename !== 'ProfileSearchResult', 'ProfileSearchResult is not expected in this query');
...
var GlobalProtocolStatsFragmentDoc = gql__default["default"](_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  fragment GlobalProtocolStats on GlobalProtocolStats {\n    totalProfiles\n    totalBurntProfiles\n    totalPosts\n    totalMirrors\n    totalComments\n    totalCollects\n    totalFollows\n    totalRevenue {\n      asset {\n        ...Erc20\n      }\n      value\n    }\n  }\n  ", "\n"])), Erc20FragmentDoc);
var GlobalProtocolStatsDocument = gql__default["default"](_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n  query GlobalProtocolStats($request: GlobalProtocolStatsRequest) {\n    result: globalProtocolStats(request: $request) {\n      ...GlobalProtocolStats\n    }\n  }\n  ", "\n"])), GlobalProtocolStatsFragmentDoc);
var defaultWrapper$1 = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var GlobalProtocolStatsDocumentString = graphql.print(GlobalProtocolStatsDocument);
...
var TransactionIndexedResultFragmentDoc = gql__default["default"](_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  fragment TransactionIndexedResult on TransactionIndexedResult {\n    __typename\n    indexed\n    txHash\n  }\n"])));
var TransactionErrorFragmentDoc = gql__default["default"](_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  fragment TransactionError on TransactionError {\n    __typename\n    reason\n  }\n"])));
var HasTxHashBeenIndexedDocument = gql__default["default"](_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  query HasTxHashBeenIndexed($request: HasTxHashBeenIndexedRequest!) {\n    result: hasTxHashBeenIndexed(request: $request) {\n      ... on TransactionIndexedResult {\n        ...TransactionIndexedResult\n      }\n      ... on TransactionError {\n        ...TransactionError\n      }\n    }\n  }\n  ", "\n  ", "\n"])), TransactionIndexedResultFragmentDoc, TransactionErrorFragmentDoc);
var BroadcastProtocolCallDocument = gql__default["default"](_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  mutation BroadcastProtocolCall($request: BroadcastRequest!) {\n    result: broadcast(request: $request) {\n      ... on RelayerResult {\n        ...RelayerResult\n      }\n      ... on RelayError {\n        ...RelayError\n      }\n    }\n  }\n  ", "\n  ", "\n"])), RelayerResultFragmentDoc, RelayErrorFragmentDoc);
var BroadcastDataAvailabilityDocument = gql__default["default"](_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  mutation BroadcastDataAvailability($request: BroadcastRequest!) {\n    result: broadcastDataAvailability(request: $request) {\n      ... on CreateDataAvailabilityPublicationResult {\n        ...CreateDataAvailabilityPublicationResult\n      }\n      ... on RelayError {\n        ...RelayError\n      }\n    }\n  }\n  ", "\n  ", "\n"])), CreateDataAvailabilityPublicationResultFragmentDoc, RelayErrorFragmentDoc);
var defaultWrapper = function defaultWrapper(action, _operationName, _operationType) {
  return action();
};
var HasTxHashBeenIndexedDocumentString = graphql.print(HasTxHashBeenIndexedDocument);
var BroadcastProtocolCallDocumentString = graphql.print(BroadcastProtocolCallDocument);
var BroadcastDataAvailabilityDocumentString = graphql.print(BroadcastDataAvailabilityDocument);
...
var sandbox = new Environment('sandbox', 'https://api-sandbox-mumbai.lens.dev');
...
exports.Stats = Stats;
exports.StatusPollingError = StatusPollingError;
exports.Transaction = Transaction;
exports.TransactionPollingError = TransactionPollingError;
exports.buildReportingReasonInputParams = buildReportingReasonInputParams;
exports.development = development;
exports.isCommentPublication = isCommentPublication;
exports.isCreateDataAvailabilityPublicationResult = isCreateDataAvailabilityPublicationResult;
exports.isMirrorPublication = isMirrorPublication;
exports.isPostPublication = isPostPublication;
exports.isProxyActionError = isProxyActionError;
exports.isProxyActionQueued = isProxyActionQueued;
exports.isProxyActionStatusResult = isProxyActionStatusResult;
exports.isRelayerError = isRelayerError;
exports.isRelayerResult = isRelayerResult;
exports.isTransactionError = isTransactionError;
exports.isTransactionIndexedResult = isTransactionIndexedResult;
