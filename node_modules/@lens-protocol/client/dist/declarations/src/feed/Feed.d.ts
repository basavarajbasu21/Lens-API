...
import { FeedItemFragment } from './graphql/feed.generated';
/**
...
export declare class Feed {
     ...
     * ```
     */
    fetch(request: FeedRequest, observerId?: string): PromiseResult<PaginatedResult<FeedItemFragment>, CredentialsExpiredError | NotAuthenticatedError>;
    /**
     ...
     * ```
     */
    fetchHighlights(request: FeedHighlightsRequest, observerId?: string): PromiseResult<PaginatedResult<PublicationFragment>, CredentialsExpiredError | NotAuthenticatedError>;
}
